...
##
DOMTestCase('HTMLParamElement03') do
  ...
  def test_HTMLParamElement03
    ...
    doc = load_document("param", false)
      ...
      assert_equal("ref", vvaluetype, "valueTypeLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLParamElement03"
  end
end
