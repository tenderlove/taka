...
##
DOMTestCase('HTMLAreaElement06') do
  ...
  def test_HTMLAreaElement06
    ...
    doc = load_document("area", false)
      ...
      assertEqualsIgnoreCase("shapeLink", "rect", vshape)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLAreaElement06"
  end
end
