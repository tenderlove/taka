...
DOMTestCase('HTMLElement47') do
  ...
  def test_HTMLElement47
    ...
    doc = load_document("element", false)
      ...
      assert_equal("SAMP Element", vtitle, "titleLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement47"
  end
end
