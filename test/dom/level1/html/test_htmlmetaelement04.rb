...
##
DOMTestCase('HTMLMetaElement04') do
  ...
  def test_HTMLMetaElement04
    ...
    doc = load_document("meta", false)
      ...
      assert_equal("NIST", vscheme, "schemeLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLMetaElement04"
  end
end
