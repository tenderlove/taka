...
##
DOMTestCase('HTMLAnchorElement07') do
  ...
  def test_HTMLAnchorElement07
    ...
    doc = load_document("anchor", false)
      ...
      vrel = testNode.rel()
      assert_equal("GLOSSARY", vrel, "relLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLAnchorElement07"
  end
end
