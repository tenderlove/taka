...
DOMTestCase('HTMLElement40') do
  ...
  def test_HTMLElement40
    ...
    doc = load_document("element", false)
      ...
      assert_equal("STRIKE Element", vtitle, "titleLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement40"
  end
end
