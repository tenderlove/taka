...
DOMTestCase('HTMLElement36') do
  ...
  def test_HTMLElement36
    ...
    doc = load_document("element", false)
      ...
      assert_equal("I Element", vtitle, "titleLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement36"
  end
end
