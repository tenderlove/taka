...
##
DOMTestCase('HTMLButtonElement07') do
  ...
  def test_HTMLButtonElement07
    ...
    doc = load_document("button", false)
      ...
      vtype = testNode.type()
      assert_equal("reset", vtype, "typeLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLButtonElement07"
  end
end
