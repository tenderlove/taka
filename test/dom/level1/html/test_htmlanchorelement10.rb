...
##
DOMTestCase('HTMLAnchorElement10') do
  ...
  def test_HTMLAnchorElement10
    ...
    doc = load_document("anchor", false)
      ...
      assert_equal(22, vtabindex, "tabIndexLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLAnchorElement10"
  end
end
