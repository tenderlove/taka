...
##
DOMTestCase('HTMLFrameElement07') do
  ...
  def test_HTMLFrameElement07
    ...
    doc = load_document("frame", false)
      ...
      assert_equal("yes", vscrolling, "scrollingLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLFrameElement07"
  end
end
