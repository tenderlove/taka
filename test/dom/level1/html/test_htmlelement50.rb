...
DOMTestCase('HTMLElement50') do
  ...
  def test_HTMLElement50
    ...
    doc = load_document("element", false)
      ...
      assert_equal("CITE Element", vtitle, "titleLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement50"
  end
end
