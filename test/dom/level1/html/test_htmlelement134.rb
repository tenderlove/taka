...
DOMTestCase('HTMLElement134') do
  ...
  def test_HTMLElement134
    ...
    doc = load_document("element", false)
      ...
      assert_equal("SAMP-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement134"
  end
end
