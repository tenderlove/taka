...
##
DOMTestCase('HTMLButtonElement05') do
  ...
  def test_HTMLButtonElement05
    ...
    doc = load_document("button", false)
      ...
      vname = testNode.name()
      assert_equal("disabledButton", vname, "nameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLButtonElement05"
  end
end
