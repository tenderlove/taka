...
##
DOMTestCase('HTMLTextAreaElement10') do
  ...
  #
  def test_HTMLTextAreaElement10
    nodeList = nil
    testNode = nil
    vtabindex = nil
    doc = nil
    doc = load_document("textarea", false)
      ...
      assert_equal(5, vtabindex, "tabIndexLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTextAreaElement10"
  end
end
