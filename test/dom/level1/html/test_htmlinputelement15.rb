...
##
DOMTestCase('HTMLInputElement15') do
  ...
  def test_HTMLInputElement15
    ...
    doc = load_document("input", false)
      ...
      assert_equal(9, vtabindex, "tabindexLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLInputElement15"
  end
end
