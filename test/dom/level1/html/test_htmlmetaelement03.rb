...
##
DOMTestCase('HTMLMetaElement03') do
  ...
  def test_HTMLMetaElement03
    ...
    doc = load_document("meta", false)
      ...
      vname = testNode.name()
      assert_equal("Meta-Name", vname, "nameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLMetaElement03"
  end
end
