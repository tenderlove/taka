...
##
DOMTestCase('HTMLButtonElement06') do
  ...
  def test_HTMLButtonElement06
    ...
    doc = load_document("button", false)
      ...
      assert_equal(20, vtabindex, "tabIndexLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLButtonElement06"
  end
end
