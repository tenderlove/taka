...
##
DOMTestCase('HTMLTableCellElement17') do
  ...
  #
  def test_HTMLTableCellElement17
    nodeList = nil
    testNode = nil
    vheaders = nil
    doc = nil
    doc = load_document("tablecell", false)
      ...
      assert_equal("header-1", vheaders, "headersLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableCellElement17"
  end
end
