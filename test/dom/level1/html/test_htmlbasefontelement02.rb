...
##
DOMTestCase('HTMLBaseFontElement02') do
  ...
  #
  def test_HTMLBaseFontElement02
    nodeList = nil
    testNode = nil
    vface = nil
    doc = nil
    doc = load_document("basefont", false)
      nodeList = doc.getElementsByTagName("basefont")
      assertSize("Asize", 1, nodeList)
      testNode = nodeList.item(0)
      vface = testNode.face()
      assert_equal("arial,helvitica", vface, "faceLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLBaseFontElement02"
  end
end
