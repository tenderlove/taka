...
##
DOMTestCase('HTMLTableCellElement23') do
  ...
  #
  def test_HTMLTableCellElement23
    nodeList = nil
    testNode = nil
    vrowspan = nil
    doc = nil
    doc = load_document("tablecell", false)
      ...
      assert_equal(1, vrowspan, "rowSpanLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableCellElement23"
  end
end
