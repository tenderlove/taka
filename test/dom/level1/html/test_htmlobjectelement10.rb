...
##
DOMTestCase('HTMLObjectElement10') do
  ...
  def test_HTMLObjectElement10
    ...
    doc = load_document("object", false)
      ...
      assert_equal("60", vheight, "heightLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLObjectElement10"
  end
end
