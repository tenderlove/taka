...
##
DOMTestCase('HTMLImageElement03') do
  ...
  def test_HTMLImageElement03
    ...
    doc = load_document("img", false)
      ...
      valt = testNode.alt()
      assert_equal("DTS IMAGE LOGO", valt, "altLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLImageElement03"
  end
end
