...
##
DOMTestCase('HTMLInputElement14') do
  ...
  def test_HTMLInputElement14
    ...
    doc = load_document("input", false)
      ...
      vsrc = testNode.src()
      assertURIEquals("srcLink", nil, nil, nil, "submit.gif", nil, nil, nil, nil, vsrc)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLInputElement14"
  end
end
