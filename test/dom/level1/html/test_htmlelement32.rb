...
DOMTestCase('HTMLElement32') do
  ...
  def test_HTMLElement32
    ...
    doc = load_document("element", false)
      ...
      assert_equal("SUP Element", vtitle, "titleLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement32"
  end
end
