...
##
DOMTestCase('HTMLFontElement02') do
  ...
  #
  def test_HTMLFontElement02
    nodeList = nil
    testNode = nil
    vface = nil
    doc = nil
    doc = load_document("font", false)
      nodeList = doc.getElementsByTagName("font")
      assertSize("Asize", 1, nodeList)
      testNode = nodeList.item(0)
      vface = testNode.face()
      assert_equal("arial,helvetica", vface, "faceLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLFontElement02"
  end
end
