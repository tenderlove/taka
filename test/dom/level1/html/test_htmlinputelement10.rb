...
##
DOMTestCase('HTMLInputElement10') do
  ...
  def test_HTMLInputElement10
    ...
    doc = load_document("input", false)
      ...
      assert_equal(5, vmaxlength, "maxlengthLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLInputElement10"
  end
end
