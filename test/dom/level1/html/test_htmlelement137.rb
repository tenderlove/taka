...
DOMTestCase('HTMLElement137') do
  ...
  def test_HTMLElement137
    ...
    doc = load_document("element", false)
      ...
      assert_equal("CITE-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement137"
  end
end
