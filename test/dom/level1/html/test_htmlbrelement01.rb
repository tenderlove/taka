...
##
DOMTestCase('HTMLBRElement01') do
  ...
  #
  def test_HTMLBRElement01
    nodeList = nil
    testNode = nil
    vclear = nil
    doc = nil
    doc = load_document("br", false)
      nodeList = doc.getElementsByTagName("br")
      assertSize("Asize", 1, nodeList)
      testNode = nodeList.item(0)
      vclear = testNode.clear()
      assert_equal("none", vclear, "clearLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLBRElement01"
  end
end
