...
##
DOMTestCase('HTMLTableSectionElement08') do
  ...
  #
  def test_HTMLTableSectionElement08
    nodeList = nil
    testNode = nil
    vcharoff = nil
    doc = nil
    doc = load_document("tablesection", false)
      ...
      assert_equal("2", vcharoff, "chOffLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableSectionElement08"
  end
end
