...
##
DOMTestCase('HTMLAppletElement06') do
  ...
  def test_HTMLAppletElement06
    ...
    doc = load_document("applet", false)
      ...
      assert_equal("306", vheight, "heightLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLAppletElement06"
  end
end
