...
##
DOMTestCase('HTMLCollection12') do
  ...
  def test_HTMLCollection12
    ...
    doc = load_document("collection", false)
      ...
      assert_nil(formNode, "nameIndexLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLCollection12"
  end
end
