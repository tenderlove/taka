...
DOMTestCase('HTMLElement37') do
  ...
  def test_HTMLElement37
    ...
    doc = load_document("element", false)
      ...
      assert_equal("B Element", vtitle, "titleLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement37"
  end
end
