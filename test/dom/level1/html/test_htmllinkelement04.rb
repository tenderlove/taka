...
##
DOMTestCase('HTMLLinkElement04') do
  ...
  def test_HTMLLinkElement04
    ...
    doc = load_document("link", false)
      ...
      assert_equal("en", vhreflang, "hreflangLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLLinkElement04"
  end
end
