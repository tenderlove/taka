...
##
DOMTestCase('HTMLTableCellElement10') do
  ...
  #
  def test_HTMLTableCellElement10
    nodeList = nil
    testNode = nil
    vbgcolor = nil
    doc = nil
    doc = load_document("tablecell", false)
      ...
      assertEqualsIgnoreCase("bgColorLink", "#FF0000", vbgcolor)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableCellElement10"
  end
end
