...
##
DOMTestCase('HTMLAreaElement08') do
  ...
  #
  def test_HTMLAreaElement08
    nodeList = nil
    testNode = nil
    vtarget = nil
    doc = nil
    doc = load_document("area2", false)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLAreaElement08"
  end
end
