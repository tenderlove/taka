...
##
DOMTestCase('HTMLLIElement01') do
  ...
  #
  def test_HTMLLIElement01
    nodeList = nil
    testNode = nil
    vtype = nil
    doc = nil
    doc = load_document("li", false)
      nodeList = doc.getElementsByTagName("li")
      assertSize("Asize", 2, nodeList)
      testNode = nodeList.item(0)
      vtype = testNode.type()
      assert_equal("square", vtype, "typeLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLLIElement01"
  end
end
