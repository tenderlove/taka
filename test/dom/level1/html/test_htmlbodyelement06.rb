...
##
DOMTestCase('HTMLBodyElement06') do
  ...
  def test_HTMLBodyElement06
    ...
    doc = load_document("body", false)
      ...
      assert_equal("#00ffff", vvlink, "vLinkLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLBodyElement06"
  end
end
