...
DOMTestCase('HTMLElement51') do
  ...
  def test_HTMLElement51
    ...
    doc = load_document("element", false)
      ...
      assert_equal("ACRONYM Element", vtitle, "titleLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement51"
  end
end
