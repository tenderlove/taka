...
DOMTestCase('HTMLElement39') do
  ...
  def test_HTMLElement39
    ...
    doc = load_document("element", false)
      ...
      assert_equal("S Element", vtitle, "titleLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement39"
  end
end
