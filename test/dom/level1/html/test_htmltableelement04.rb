...
##
DOMTestCase('HTMLTableElement04') do
  ...
  def test_HTMLTableElement04
    ...
    doc = load_document("table", false)
      ...
      assert_nil(vsection, "sectionLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableElement04"
  end
end
