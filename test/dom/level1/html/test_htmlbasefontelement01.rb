...
##
DOMTestCase('HTMLBaseFontElement01') do
  ...
  #
  def test_HTMLBaseFontElement01
    nodeList = nil
    testNode = nil
    vcolor = nil
    doc = nil
    doc = load_document("basefont", false)
      ...
      assert_equal("#000000", vcolor, "colorLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLBaseFontElement01"
  end
end
