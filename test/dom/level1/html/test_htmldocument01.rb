...
DOMTestCase('HTMLDocument01') do
  ...
  #
  def test_HTMLDocument01
    nodeList = nil
    vtitle = nil
    doc = nil
    doc = load_document("document", false)
      vtitle = doc.title()
      assert_equal("NIST DOM HTML Test - DOCUMENT", vtitle, "titleLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLDocument01"
  end
end
