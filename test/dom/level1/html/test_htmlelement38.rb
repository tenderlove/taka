...
DOMTestCase('HTMLElement38') do
  ...
  def test_HTMLElement38
    ...
    doc = load_document("element", false)
      ...
      assert_equal("U Element", vtitle, "titleLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement38"
  end
end
