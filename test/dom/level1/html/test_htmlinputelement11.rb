...
##
DOMTestCase('HTMLInputElement11') do
  ...
  def test_HTMLInputElement11
    ...
    doc = load_document("input", false)
      ...
      vname = testNode.name()
      assert_equal("Password", vname, "nameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLInputElement11"
  end
end
