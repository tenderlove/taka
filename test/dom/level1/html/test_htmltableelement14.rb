...
##
DOMTestCase('HTMLTableElement14') do
  ...
  def test_HTMLTableElement14
    ...
    doc = load_document("table", false)
      ...
      assert_equal("2", cellSpacing, "cellSpacingLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableElement14"
  end
end
