...
##
DOMTestCase('HTMLScriptElement01') do
  ...
  def test_HTMLScriptElement01
    ...
    doc = load_document("script", false)
      ...
      vtext = testNode.text()
      assert_equal("var a=2;", vtext, "textLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLScriptElement01"
  end
end
