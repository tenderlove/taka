...
DOMTestCase('HTMLElement35') do
  ...
  def test_HTMLElement35
    ...
    doc = load_document("element", false)
      ...
      assert_equal("TT Element", vtitle, "titleLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement35"
  end
end
