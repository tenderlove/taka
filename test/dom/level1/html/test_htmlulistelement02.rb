...
##
DOMTestCase('HTMLUListElement02') do
  ...
  #
  def test_HTMLUListElement02
    nodeList = nil
    testNode = nil
    vtype = nil
    doc = nil
    doc = load_document("ulist", false)
      nodeList = doc.getElementsByTagName("ul")
      assertSize("Asize", 2, nodeList)
      testNode = nodeList.item(0)
      vtype = testNode.type()
      assert_equal("disc", vtype, "typeLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLUListElement02"
  end
end
