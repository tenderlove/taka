...
##
DOMTestCase('HTMLInputElement17') do
  ...
  def test_HTMLInputElement17
    ...
    doc = load_document("input", false)
      ...
      assert_equal("#submit-map", vusemap, "usemapLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLInputElement17"
  end
end
