...
##
DOMTestCase('HTMLBaseElement01') do
  ...
  #
  def test_HTMLBaseElement01
    nodeList = nil
    testNode = nil
    vhref = nil
    doc = nil
    doc = load_document("base", false)
      nodeList = doc.getElementsByTagName("base")
      assertSize("Asize", 1, nodeList)
      testNode = nodeList.item(0)
      vhref = testNode.href()
      assert_equal("about:blank", vhref, "hrefLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLBaseElement01"
  end
end
