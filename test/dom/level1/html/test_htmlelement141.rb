...
DOMTestCase('HTMLElement141') do
  ...
  def test_HTMLElement141
    ...
    doc = load_document("element", false)
      ...
      assert_equal("DT-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement141"
  end
end
