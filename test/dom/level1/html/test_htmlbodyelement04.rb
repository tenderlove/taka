...
##
DOMTestCase('HTMLBodyElement04') do
  ...
  def test_HTMLBodyElement04
    ...
    doc = load_document("body", false)
      ...
      vlink = testNode.link()
      assert_equal("#ff0000", vlink, "linkLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLBodyElement04"
  end
end
