...
##
DOMTestCase('HTMLObjectElement12') do
  ...
  def test_HTMLObjectElement12
    ...
    doc = load_document("object", false)
      ...
      assert_equal("Loading Image ...", vstandby, "alignLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLObjectElement12"
  end
end
