...
##
DOMTestCase('HTMLFormElement02') do
  ...
  def test_HTMLFormElement02
    ...
    doc = load_document("form", false)
      ...
      assert_equal(3, vlength, "lengthLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLFormElement02"
  end
end
