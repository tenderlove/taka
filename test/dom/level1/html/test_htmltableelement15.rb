...
##
DOMTestCase('HTMLTableElement15') do
  ...
  def test_HTMLTableElement15
    ...
    doc = load_document("table", false)
      ...
      assert_equal("border", vframe, "frameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableElement15"
  end
end
