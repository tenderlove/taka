...
##
DOMTestCase('HTMLAreaElement01') do
  ...
  def test_HTMLAreaElement01
    ...
    doc = load_document("area", false)
      ...
      assert_equal("a", vaccesskey, "alignLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLAreaElement01"
  end
end
