...
##
DOMTestCase('HTMLObjectElement07') do
  ...
  def test_HTMLObjectElement07
    ...
    doc = load_document("object", false)
      ...
      assert_equal("image/gif", vcodetype, "codetypeLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLObjectElement07"
  end
end
