...
##
DOMTestCase('HTMLFrameElement05') do
  ...
  def test_HTMLFrameElement05
    ...
    doc = load_document("frame", false)
      ...
      vname = testNode.name()
      assert_equal("Frame1", vname, "nameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLFrameElement05"
  end
end
