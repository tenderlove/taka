...
##
DOMTestCase('HTMLAnchorElement05') do
  ...
  def test_HTMLAnchorElement05
    ...
    doc = load_document("anchor", false)
      ...
      assert_equal("en", vhreflink, "hreflangLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLAnchorElement05"
  end
end
