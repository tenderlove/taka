...
##
DOMTestCase('HTMLParamElement02') do
  ...
  #
  def test_HTMLParamElement02
    nodeList = nil
    testNode = nil
    vvalue = nil
    doc = nil
    doc = load_document("param", false)
      nodeList = doc.getElementsByTagName("param")
      assertSize("Asize", 1, nodeList)
      testNode = nodeList.item(0)
      vvalue = testNode.value()
      assertURIEquals("valueLink", nil, nil, nil, "file.gif", nil, nil, nil, nil, vvalue)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLParamElement02"
  end
end
