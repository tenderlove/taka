...
DOMTestCase('HTMLElement145') do
  ...
  def test_HTMLElement145
    ...
    doc = load_document("element", false)
      ...
      assert_equal("CENTER-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement145"
  end
end
