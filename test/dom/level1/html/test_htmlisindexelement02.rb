...
##
DOMTestCase('HTMLIsIndexElement02') do
  ...
  def test_HTMLIsIndexElement02
    ...
    doc = load_document("isindex", false)
      ...
      assert_equal("Old Employee: ", prompt, "IsIndex.Prompt")
            vform = testNode.form()
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLIsIndexElement02"
  end
end
