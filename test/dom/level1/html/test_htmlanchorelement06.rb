...
##
DOMTestCase('HTMLAnchorElement06') do
  ...
  def test_HTMLAnchorElement06
    ...
    doc = load_document("anchor", false)
      ...
      vname = testNode.name()
      assert_equal("Anchor", vname, "nameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLAnchorElement06"
  end
end
