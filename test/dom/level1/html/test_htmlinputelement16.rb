...
##
DOMTestCase('HTMLInputElement16') do
  ...
  def test_HTMLInputElement16
    ...
    doc = load_document("input", false)
      ...
      vtype = testNode.type()
      assert_equal("password", vtype, "typeLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLInputElement16"
  end
end
