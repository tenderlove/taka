...
DOMTestCase('HTMLElement45') do
  ...
  def test_HTMLElement45
    ...
    doc = load_document("element", false)
      ...
      assert_equal("DFN Element", vtitle, "titleLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement45"
  end
end
