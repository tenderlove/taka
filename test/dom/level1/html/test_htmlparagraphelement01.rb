...
##
DOMTestCase('HTMLParagraphElement01') do
  ...
  #
  def test_HTMLParagraphElement01
    nodeList = nil
    testNode = nil
    valign = nil
    doc = nil
    doc = load_document("paragraph", false)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLParagraphElement01"
  end
end
