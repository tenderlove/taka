...
##
DOMTestCase('HTMLTableElement08') do
  ...
  def test_HTMLTableElement08
    ...
    doc = load_document("table", false)
      ...
      indexN65632 = 0
    while (indexN65632 < tbodiesnodeList.length)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableElement08"
  end
end
