...
##
DOMTestCase('HTMLTableColElement06') do
  ...
  #
  def test_HTMLTableColElement06
    nodeList = nil
    testNode = nil
    vchoff = nil
    doc = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableColElement06"
  end
end
