...
##
DOMTestCase('HTMLTableColElement11') do
  ...
  #
  def test_HTMLTableColElement11
    nodeList = nil
    testNode = nil
    vwidth = nil
    doc = nil
    doc = load_document("tablecol", false)
      ...
      assert_equal("20", vwidth, "widthLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableColElement11"
  end
end
