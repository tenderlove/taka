...
##
DOMTestCase('HTMLAnchorElement09') do
  ...
  def test_HTMLAnchorElement09
    ...
    doc = load_document("anchor", false)
      ...
      assert_equal("rect", vshape, "shapeLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLAnchorElement09"
  end
end
