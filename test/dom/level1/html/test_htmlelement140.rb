...
DOMTestCase('HTMLElement140') do
  ...
  def test_HTMLElement140
    ...
    doc = load_document("element", false)
      ...
      assert_equal("DD-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement140"
  end
end
