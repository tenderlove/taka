...
##
DOMTestCase('HTMLAnchorElement08') do
  ...
  def test_HTMLAnchorElement08
    ...
    doc = load_document("anchor", false)
      ...
      vrev = testNode.rev()
      assert_equal("STYLESHEET", vrev, "revLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLAnchorElement08"
  end
end
