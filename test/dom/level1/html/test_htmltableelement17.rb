...
##
DOMTestCase('HTMLTableElement17') do
  ...
  def test_HTMLTableElement17
    ...
    doc = load_document("table", false)
      ...
      assert_equal("HTML Control Table", vsummary, "summaryLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableElement17"
  end
end
