...
DOMTestCase('HTMLElement132') do
  ...
  def test_HTMLElement132
    ...
    doc = load_document("element", false)
      ...
      assert_equal("DFN-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement132"
  end
end
