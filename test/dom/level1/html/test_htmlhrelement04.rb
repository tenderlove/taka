...
##
DOMTestCase('HTMLHRElement04') do
  ...
  def test_HTMLHRElement04
    ...
    doc = load_document("hr", false)
      ...
      assert_equal("400", vwidth, "widthLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLHRElement04"
  end
end
