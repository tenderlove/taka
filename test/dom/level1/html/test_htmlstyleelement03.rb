...
##
DOMTestCase('HTMLStyleElement03') do
  ...
  def test_HTMLStyleElement03
    ...
    doc = load_document("style", false)
      ...
      vtype = testNode.type()
      assert_equal("text/css", vtype, "typeLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLStyleElement03"
  end
end
