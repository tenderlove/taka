...
##
DOMTestCase('HTMLTableColElement07') do
  ...
  #
  def test_HTMLTableColElement07
    nodeList = nil
    testNode = nil
    vspan = nil
    doc = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableColElement07"
  end
end
