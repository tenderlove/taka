...
##
DOMTestCase('HTMLHeadElement01') do
  ...
  #
  def test_HTMLHeadElement01
    nodeList = nil
    testNode = nil
    vprofile = nil
    doc = nil
    doc = load_document("head", false)
      nodeList = doc.getElementsByTagName("head")
      assertSize("Asize", 1, nodeList)
      testNode = nodeList.item(0)
      vprofile = testNode.profile()
      assertURIEquals("profileLink", nil, nil, nil, "profile", nil, nil, nil, nil, vprofile)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLHeadElement01"
  end
end
