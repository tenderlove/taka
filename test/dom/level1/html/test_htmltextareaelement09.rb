...
##
DOMTestCase('HTMLTextAreaElement09') do
  ...
  #
  def test_HTMLTextAreaElement09
    nodeList = nil
    testNode = nil
    vrows = nil
    doc = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTextAreaElement09"
  end
end
