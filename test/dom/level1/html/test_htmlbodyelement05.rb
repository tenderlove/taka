...
##
DOMTestCase('HTMLBodyElement05') do
  ...
  def test_HTMLBodyElement05
    ...
    doc = load_document("body", false)
      ...
      vtext = testNode.text()
      assert_equal("#000000", vtext, "textLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLBodyElement05"
  end
end
