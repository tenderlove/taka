...
DOMTestCase('HTMLElement117') do
  ...
  def test_HTMLElement117
    ...
    doc = load_document("element", false)
      ...
      assert_equal("HEAD-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement117"
  end
end
