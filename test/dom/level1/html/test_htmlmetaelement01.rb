...
##
DOMTestCase('HTMLMetaElement01') do
  ...
  #
  def test_HTMLMetaElement01
    nodeList = nil
    testNode = nil
    vcontent = nil
    doc = nil
    doc = load_document("meta", false)
      nodeList = doc.getElementsByTagName("meta")
      assertSize("Asize", 1, nodeList)
      testNode = nodeList.item(0)
      vcontent = testNode.content()
      assert_equal("text/html; CHARSET=utf-8", vcontent, "contentLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLMetaElement01"
  end
end
