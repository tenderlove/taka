...
##
DOMTestCase('HTMLObjectElement03') do
  ...
  def test_HTMLObjectElement03
    ...
    doc = load_document("object", false)
      ...
      assert_equal("middle", valign, "alignLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLObjectElement03"
  end
end
