...
##
DOMTestCase('HTMLTableCellElement30') do
  ...
  #
  def test_HTMLTableCellElement30
    nodeList = nil
    testNode = nil
    vwidth = nil
    doc = nil
    doc = load_document("tablecell", false)
      ...
      assert_equal("175", vwidth, "widthLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableCellElement30"
  end
end
