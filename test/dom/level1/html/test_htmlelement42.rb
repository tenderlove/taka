...
DOMTestCase('HTMLElement42') do
  ...
  def test_HTMLElement42
    ...
    doc = load_document("element", false)
      ...
      assert_equal("SMALL Element", vtitle, "titleLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement42"
  end
end
