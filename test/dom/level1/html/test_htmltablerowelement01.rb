...
##
DOMTestCase('HTMLTableRowElement01') do
  ...
  #
  def test_HTMLTableRowElement01
    nodeList = nil
    testNode = nil
    vrowindex = nil
    doc = nil
    doc = load_document("tablerow", false)
      ...
      assert_equal(1, vrowindex, "rowIndexLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableRowElement01"
  end
end
