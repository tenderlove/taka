...
##
DOMTestCase('HTMLOListElement02') do
  ...
  #
  def test_HTMLOListElement02
    nodeList = nil
    testNode = nil
    vstart = nil
    doc = nil
    doc = load_document("olist", false)
      nodeList = doc.getElementsByTagName("ol")
      assertSize("Asize", 1, nodeList)
      testNode = nodeList.item(0)
      vstart = testNode.start()
      assert_equal(1, vstart, "startLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLOListElement02"
  end
end
