...
##
DOMTestCase('HTMLLabelElement04') do
  ...
  #
  def test_HTMLLabelElement04
    nodeList = nil
    testNode = nil
    vhtmlfor = nil
    doc = nil
    doc = load_document("label", false)
      nodeList = doc.getElementsByTagName("label")
      assertSize("Asize", 2, nodeList)
      testNode = nodeList.item(0)
      vhtmlfor = testNode.htmlFor()
      assert_equal("input1", vhtmlfor, "htmlForLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLLabelElement04"
  end
end
