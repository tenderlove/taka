...
##
DOMTestCase('HTMLTextAreaElement07') do
  ...
  #
  def test_HTMLTextAreaElement07
    nodeList = nil
    testNode = nil
    vname = nil
    doc = nil
    doc = load_document("textarea", false)
      ...
      vname = testNode.name()
      assert_equal("text1", vname, "nameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTextAreaElement07"
  end
end
