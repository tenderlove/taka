...
DOMTestCase('HTMLElement135') do
  ...
  def test_HTMLElement135
    ...
    doc = load_document("element", false)
      ...
      assert_equal("KBD-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement135"
  end
end
