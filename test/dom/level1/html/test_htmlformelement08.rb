...
##
DOMTestCase('HTMLFormElement08') do
  ...
  #
  def test_HTMLFormElement08
    nodeList = nil
    testNode = nil
    vtarget = nil
    doc = nil
    doc = load_document("form2", false)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLFormElement08"
  end
end
