...
##
DOMTestCase('HTMLSelectElement04') do
  ...
  def test_HTMLSelectElement04
    ...
    doc = load_document("select", false)
      ...
      assert_equal("EMP1", vvalue, "valueLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLSelectElement04"
  end
end
