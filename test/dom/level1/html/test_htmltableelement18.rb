...
##
DOMTestCase('HTMLTableElement18') do
  ...
  def test_HTMLTableElement18
    ...
    doc = load_document("table", false)
      ...
      assert_equal("680", vwidth, "widthLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableElement18"
  end
end
