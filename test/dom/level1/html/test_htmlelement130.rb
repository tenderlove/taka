...
DOMTestCase('HTMLElement130') do
  ...
  def test_HTMLElement130
    ...
    doc = load_document("element", false)
      ...
      assert_equal("EM-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement130"
  end
end
