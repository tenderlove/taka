...
DOMTestCase('HTMLElement119') do
  ...
  def test_HTMLElement119
    ...
    doc = load_document("element", false)
      ...
      assert_equal("SUP-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement119"
  end
end
