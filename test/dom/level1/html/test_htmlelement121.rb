...
DOMTestCase('HTMLElement121') do
  ...
  def test_HTMLElement121
    ...
    doc = load_document("element", false)
      ...
      assert_equal("BDO-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement121"
  end
end
