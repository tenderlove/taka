...
DOMTestCase('HTMLElement41') do
  ...
  def test_HTMLElement41
    ...
    doc = load_document("element", false)
      ...
      assert_equal("BIG Element", vtitle, "titleLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement41"
  end
end
