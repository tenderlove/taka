...
##
DOMTestCase('HTMLBaseElement02') do
  ...
  #
  def test_HTMLBaseElement02
    nodeList = nil
    testNode = nil
    vtarget = nil
    doc = nil
    doc = load_document("base2", false)
      nodeList = doc.getElementsByTagName("base")
      assertSize("Asize", 1, nodeList)
      testNode = nodeList.item(0)
      vtarget = testNode.target()
      assert_equal("Frame1", vtarget, "targetLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLBaseElement02"
  end
end
