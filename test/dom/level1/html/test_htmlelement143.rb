...
DOMTestCase('HTMLElement143') do
  ...
  def test_HTMLElement143
    ...
    doc = load_document("element", false)
      ...
      assert_equal("NOSCRIPT-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement143"
  end
end
