...
##
DOMTestCase('HTMLOptionElement05') do
  ...
  def test_HTMLOptionElement05
    ...
    doc = load_document("option", false)
      ...
      assert_equal(1, vindex, "indexLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLOptionElement05"
  end
end
