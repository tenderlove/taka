...
##
DOMTestCase('HTMLSelectElement11') do
  ...
  def test_HTMLSelectElement11
    ...
    doc = load_document("select", false)
      ...
      vname = testNode.name()
      assert_equal("select1", vname, "nameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLSelectElement11"
  end
end
