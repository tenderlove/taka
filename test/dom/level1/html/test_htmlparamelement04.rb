...
##
DOMTestCase('HTMLParamElement04') do
  ...
  def test_HTMLParamElement04
    ...
    doc = load_document("param", false)
      ...
      vtype = testNode.type()
      assert_equal("image/gif", vtype, "typeLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLParamElement04"
  end
end
