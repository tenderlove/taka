...
DOMTestCase('HTMLElement129') do
  ...
  def test_HTMLElement129
    ...
    doc = load_document("element", false)
      ...
      assert_equal("SMALL-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement129"
  end
end
