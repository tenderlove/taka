...
##
DOMTestCase('HTMLTableCellElement25') do
  ...
  #
  def test_HTMLTableCellElement25
    nodeList = nil
    testNode = nil
    vscope = nil
    doc = nil
    doc = load_document("tablecell", false)
      ...
      assert_equal("col", vscope, "scopeLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableCellElement25"
  end
end
