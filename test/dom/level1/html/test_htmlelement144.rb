...
DOMTestCase('HTMLElement144') do
  ...
  def test_HTMLElement144
    ...
    doc = load_document("element", false)
      ...
      assert_equal("ADDRESS-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement144"
  end
end
