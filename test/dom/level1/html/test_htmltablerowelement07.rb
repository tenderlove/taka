...
##
DOMTestCase('HTMLTableRowElement07') do
  ...
  #
  def test_HTMLTableRowElement07
    nodeList = nil
    testNode = nil
    vbgcolor = nil
    doc = nil
    doc = load_document("tablerow", false)
      ...
      assertEqualsIgnoreCase("bgColorLink", "#00FFFF", vbgcolor)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableRowElement07"
  end
end
