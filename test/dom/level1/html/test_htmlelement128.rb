...
DOMTestCase('HTMLElement128') do
  ...
  def test_HTMLElement128
    ...
    doc = load_document("element", false)
      ...
      assert_equal("BIG-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement128"
  end
end
