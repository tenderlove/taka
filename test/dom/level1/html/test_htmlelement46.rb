...
DOMTestCase('HTMLElement46') do
  ...
  def test_HTMLElement46
    ...
    doc = load_document("element", false)
      ...
      assert_equal("CODE Element", vtitle, "titleLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement46"
  end
end
