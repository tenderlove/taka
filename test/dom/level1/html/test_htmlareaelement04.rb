...
##
DOMTestCase('HTMLAreaElement04') do
  ...
  def test_HTMLAreaElement04
    ...
    doc = load_document("area", false)
      ...
      vhref = testNode.href()
      assertURIEquals("hrefLink", nil, nil, nil, "dletter.html", nil, nil, nil, nil, vhref)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLAreaElement04"
  end
end
