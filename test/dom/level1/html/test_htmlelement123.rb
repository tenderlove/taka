...
DOMTestCase('HTMLElement123') do
  ...
  def test_HTMLElement123
    ...
    doc = load_document("element", false)
      ...
      assert_equal("I-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement123"
  end
end
