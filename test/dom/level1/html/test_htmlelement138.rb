...
DOMTestCase('HTMLElement138') do
  ...
  def test_HTMLElement138
    ...
    doc = load_document("element", false)
      ...
      assert_equal("ACRONYM-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement138"
  end
end
