...
##
DOMTestCase('HTMLTableCellElement29') do
  ...
  #
  def test_HTMLTableCellElement29
    nodeList = nil
    testNode = nil
    vwidth = nil
    doc = nil
    doc = load_document("tablecell", false)
      ...
      assert_equal("170", vwidth, "widthLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableCellElement29"
  end
end
