...
##
DOMTestCase('HTMLTextAreaElement12') do
  ...
  #
  def test_HTMLTextAreaElement12
    nodeList = nil
    testNode = nil
    vvalue = nil
    doc = nil
    doc = load_document("textarea", false)
      ...
      assert_equal("TEXTAREA1", vvalue, "valueLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTextAreaElement12"
  end
end
