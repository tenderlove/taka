...
DOMTestCase('HTMLElement127') do
  ...
  def test_HTMLElement127
    ...
    doc = load_document("element", false)
      ...
      assert_equal("STRIKE-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement127"
  end
end
