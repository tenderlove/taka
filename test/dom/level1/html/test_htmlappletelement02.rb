...
##
DOMTestCase('HTMLAppletElement02') do
  ...
  def test_HTMLAppletElement02
    ...
    doc = load_document("applet", false)
      ...
      valt = testNode.alt()
      assert_equal("Applet Number 1", valt, "altLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLAppletElement02"
  end
end
