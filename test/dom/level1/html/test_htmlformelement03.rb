...
##
DOMTestCase('HTMLFormElement03') do
  ...
  def test_HTMLFormElement03
    ...
    doc = load_document("form", false)
      ...
      vname = testNode.id()
      assert_equal("form1", vname, "nameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLFormElement03"
  end
end
