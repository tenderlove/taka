...
##
DOMTestCase('HTMLObjectElement01') do
  ...
  def test_HTMLObjectElement01
    ...
    doc = load_document("object2", false)
      ...
      fNode = testNode.form()
      vform = fNode.id()
      assert_equal("object2", vform, "idLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLObjectElement01"
  end
end
