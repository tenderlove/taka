...
##
DOMTestCase('HTMLPreElement01') do
  ...
  #
  def test_HTMLPreElement01
    nodeList = nil
    testNode = nil
    vwidth = nil
    doc = nil
    doc = load_document("pre", false)
      nodeList = doc.getElementsByTagName("pre")
      assertSize("Asize", 1, nodeList)
      testNode = nodeList.item(0)
      vwidth = testNode.width()
      assert_equal(277, vwidth, "widthLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLPreElement01"
  end
end
