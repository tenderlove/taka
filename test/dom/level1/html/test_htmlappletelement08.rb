...
##
DOMTestCase('HTMLAppletElement08') do
  ...
  def test_HTMLAppletElement08
    ...
    doc = load_document("applet", false)
      ...
      vname = testNode.name()
      assert_equal("applet1", vname, "nameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLAppletElement08"
  end
end
