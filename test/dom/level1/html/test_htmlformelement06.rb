...
##
DOMTestCase('HTMLFormElement06') do
  ...
  def test_HTMLFormElement06
    ...
    doc = load_document("form", false)
      ...
      assert_equal("application/x-www-form-urlencoded", venctype, "enctypeLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLFormElement06"
  end
end
