...
DOMTestCase('HTMLElement120') do
  ...
  def test_HTMLElement120
    ...
    doc = load_document("element", false)
      ...
      assert_equal("SPAN-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement120"
  end
end
