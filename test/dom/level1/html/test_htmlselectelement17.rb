...
##
DOMTestCase('HTMLSelectElement17') do
  ...
  def test_HTMLSelectElement17
    ...
    doc = load_document("select", true)
      ...
      assert_equal(5, optLength, "optLength")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLSelectElement17"
  end
end
