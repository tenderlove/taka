...
##
DOMTestCase('HTMLTableSectionElement09') do
  ...
  #
  def test_HTMLTableSectionElement09
    nodeList = nil
    testNode = nil
    vcharoff = nil
    doc = nil
    doc = load_document("tablesection", false)
      ...
      assert_equal("3", vcharoff, "chOffLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableSectionElement09"
  end
end
