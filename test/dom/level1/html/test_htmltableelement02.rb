...
##
DOMTestCase('HTMLTableElement02') do
  ...
  def test_HTMLTableElement02
    ...
    doc = load_document("table", false)
      ...
      assert_nil(vcaption, "captionLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableElement02"
  end
end
