...
##
DOMTestCase('HTMLCollection08') do
  ...
  def test_HTMLCollection08
    ...
    doc = load_document("collection", false)
      ...
      assert_equal(2, vrowindex, "rowIndexLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLCollection08"
  end
end
