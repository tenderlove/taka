...
DOMTestCase('HTMLElement43') do
  ...
  def test_HTMLElement43
    ...
    doc = load_document("element", false)
      ...
      assert_equal("EM Element", vtitle, "titleLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement43"
  end
end
