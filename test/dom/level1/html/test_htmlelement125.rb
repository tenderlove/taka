...
DOMTestCase('HTMLElement125') do
  ...
  def test_HTMLElement125
    ...
    doc = load_document("element", false)
      ...
      assert_equal("U-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement125"
  end
end
