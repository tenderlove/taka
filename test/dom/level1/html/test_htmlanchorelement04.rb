...
##
DOMTestCase('HTMLAnchorElement04') do
  ...
  def test_HTMLAnchorElement04
    ...
    doc = load_document("anchor", false)
      ...
      vhref = testNode.href()
      assertURIEquals("hrefLink", nil, nil, nil, "submit.gif", nil, nil, nil, nil, vhref)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLAnchorElement04"
  end
end
