...
DOMTestCase('HTMLElement122') do
  ...
  def test_HTMLElement122
    ...
    doc = load_document("element", false)
      ...
      assert_equal("TT-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement122"
  end
end
