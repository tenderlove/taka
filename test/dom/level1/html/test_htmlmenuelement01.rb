...
##
DOMTestCase('HTMLMenuElement01') do
  ...
  #
  def test_HTMLMenuElement01
    nodeList = nil
    testNode = nil
    vcompact = nil
    doc = nil
    doc = load_document("menu", false)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLMenuElement01"
  end
end
