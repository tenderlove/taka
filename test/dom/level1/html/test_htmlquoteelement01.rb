...
##
DOMTestCase('HTMLQuoteElement01') do
  ...
  def test_HTMLQuoteElement01
    ...
    doc = load_document("quote", false)
      ...
      vcite = testNode.cite()
      assertURIEquals("citeLink", nil, nil, nil, "Q.html", nil, nil, nil, nil, vcite)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLQuoteElement01"
  end
end
