...
##
DOMTestCase('HTMLImageElement10') do
  ...
  def test_HTMLImageElement10
    ...
    doc = load_document("img", false)
      ...
      assert_equal("#DTS-MAP", vusemap, "useMapLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLImageElement10"
  end
end
