...
##
DOMTestCase('HTMLFormElement07') do
  ...
  def test_HTMLFormElement07
    ...
    doc = load_document("form", false)
      ...
      assert_equal("post", vmethod, "methodLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLFormElement07"
  end
end
