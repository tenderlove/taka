...
##
DOMTestCase('HTMLCollection07') do
  ...
  def test_HTMLCollection07
    ...
    doc = load_document("collection", false)
      ...
      assert_equal(3, vrowindex, "rowIndexLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLCollection07"
  end
end
