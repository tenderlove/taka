...
##
DOMTestCase('HTMLStyleElement02') do
  ...
  #
  def test_HTMLStyleElement02
    nodeList = nil
    testNode = nil
    vmedia = nil
    doc = nil
    doc = load_document("style", false)
      nodeList = doc.getElementsByTagName("style")
      assertSize("Asize", 1, nodeList)
      testNode = nodeList.item(0)
      vmedia = testNode.media()
      assert_equal("screen", vmedia, "mediaLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLStyleElement02"
  end
end
