...
##
DOMTestCase('HTMLTableElement16') do
  ...
  def test_HTMLTableElement16
    ...
    doc = load_document("table", false)
      ...
      assert_equal("all", vrules, "rulesLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableElement16"
  end
end
