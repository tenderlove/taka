...
##
DOMTestCase('HTMLTableRowElement09') do
  ...
  #
  def test_HTMLTableRowElement09
    nodeList = nil
    testNode = nil
    vchoff = nil
    doc = nil
    doc = load_document("tablerow", false)
      ...
      assert_equal("1", vchoff, "charOffLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableRowElement09"
  end
end
