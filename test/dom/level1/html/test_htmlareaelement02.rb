...
##
DOMTestCase('HTMLAreaElement02') do
  ...
  def test_HTMLAreaElement02
    ...
    doc = load_document("area", false)
      ...
      valt = testNode.alt()
      assert_equal("Domain", valt, "altLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLAreaElement02"
  end
end
