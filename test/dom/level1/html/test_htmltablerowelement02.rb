...
##
DOMTestCase('HTMLTableRowElement02') do
  ...
  #
  def test_HTMLTableRowElement02
    nodeList = nil
    testNode = nil
    ...
    doc = load_document("tablerow", false)
      ...
      assert_equal(0, vsectionrowindex, "sectionRowIndexLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableRowElement02"
  end
end
