...
##
DOMTestCase('HTMLTableElement11') do
  ...
  def test_HTMLTableElement11
    ...
    doc = load_document("table", false)
      ...
      assert_equal("#ff0000", vbgcolor, "bgColorLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableElement11"
  end
end
