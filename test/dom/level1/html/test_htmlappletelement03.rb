...
##
DOMTestCase('HTMLAppletElement03') do
  ...
  def test_HTMLAppletElement03
    ...
    doc = load_document("applet", false)
      ...
      assert_equal("", varchive, "archiveLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLAppletElement03"
  end
end
