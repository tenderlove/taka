...
##
DOMTestCase('HTMLTextAreaElement01') do
  ...
  #
  def test_HTMLTextAreaElement01
    nodeList = nil
    testNode = nil
    vdefaultvalue = nil
    doc = nil
    doc = load_document("textarea", false)
      ...
      assert_equal("TEXTAREA2", vdefaultvalue, "defaultValueLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTextAreaElement01"
  end
end
