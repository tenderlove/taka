...
##
DOMTestCase('HTMLBodyElement01') do
  ...
  def test_HTMLBodyElement01
    ...
    doc = load_document("body", false)
      ...
      assert_equal("#0000ff", valink, "aLinkLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLBodyElement01"
  end
end
