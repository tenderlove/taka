...
DOMTestCase('HTMLElement136') do
  ...
  def test_HTMLElement136
    ...
    doc = load_document("element", false)
      ...
      assert_equal("VAR-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement136"
  end
end
