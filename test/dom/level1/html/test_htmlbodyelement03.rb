...
##
DOMTestCase('HTMLBodyElement03') do
  ...
  def test_HTMLBodyElement03
    ...
    doc = load_document("body", false)
      ...
      assert_equal("#ffff00", vbgcolor, "bgColorLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLBodyElement03"
  end
end
