...
##
DOMTestCase('HTMLObjectElement08') do
  ...
  def test_HTMLObjectElement08
    ...
    doc = load_document("object", false)
      ...
      vdata = testNode.data()
      assertURIEquals("dataLink", nil, nil, nil, "logo.gif", nil, nil, nil, nil, vdata)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLObjectElement08"
  end
end
