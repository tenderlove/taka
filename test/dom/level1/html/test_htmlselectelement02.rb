...
##
DOMTestCase('HTMLSelectElement02') do
  ...
  def test_HTMLSelectElement02
    ...
    doc = load_document("select", false)
      ...
      assert_equal(0, vselectedindex, "selectedIndexLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLSelectElement02"
  end
end
