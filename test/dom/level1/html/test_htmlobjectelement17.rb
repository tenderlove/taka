...
##
DOMTestCase('HTMLObjectElement17') do
  ...
  def test_HTMLObjectElement17
    ...
    doc = load_document("object", false)
      ...
      assert_equal("550", vwidth, "widthLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLObjectElement17"
  end
end
