...
##
DOMTestCase('HTMLScriptElement04') do
  ...
  #
  def test_HTMLScriptElement04
    nodeList = nil
    testNode = nil
    vsrc = nil
    doc = nil
    doc = load_document("script", false)
      nodeList = doc.getElementsByTagName("script")
      assertSize("Asize", 1, nodeList)
      testNode = nodeList.item(0)
      vsrc = testNode.src()
      assertURIEquals("srcLink", nil, nil, nil, "script1.js", nil, nil, nil, nil, vsrc)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLScriptElement04"
  end
end
