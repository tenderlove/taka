...
##
DOMTestCase('HTMLTableCellElement04') do
  ...
  #
  def test_HTMLTableCellElement04
    nodeList = nil
    testNode = nil
    vabbr = nil
    doc = nil
    doc = load_document("tablecell", false)
      ...
      vabbr = testNode.abbr()
      assert_equal("hd2", vabbr, "abbrLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableCellElement04"
  end
end
