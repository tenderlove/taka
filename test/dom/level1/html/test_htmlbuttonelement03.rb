...
##
DOMTestCase('HTMLButtonElement03') do
  ...
  def test_HTMLButtonElement03
    ...
    doc = load_document("button", false)
      ...
      assert_equal("f", vaccesskey, "accessKeyLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLButtonElement03"
  end
end
