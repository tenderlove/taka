...
##
DOMTestCase('HTMLMetaElement02') do
  ...
  def test_HTMLMetaElement02
    ...
    doc = load_document("meta", false)
      ...
      assert_equal("Content-Type", vhttpequiv, "httpEquivLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLMetaElement02"
  end
end
