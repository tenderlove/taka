...
DOMTestCase('HTMLElement54') do
  ...
  def test_HTMLElement54
    ...
    doc = load_document("element", false)
      ...
      assert_equal("DT Element", vtitle, "titleLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement54"
  end
end
