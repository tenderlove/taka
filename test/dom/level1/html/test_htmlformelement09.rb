...
##
DOMTestCase('HTMLFormElement09') do
  ...
  #
  def test_HTMLFormElement09
    nodeList = nil
    testNode = nil
    doc = nil
    doc = load_document("form2", true)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLFormElement09"
  end
end
