...
DOMTestCase('HTMLElement31') do
  ...
  def test_HTMLElement31
    ...
    doc = load_document("element", false)
      ...
      assert_equal("SUB Element", vtitle, "titleLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement31"
  end
end
