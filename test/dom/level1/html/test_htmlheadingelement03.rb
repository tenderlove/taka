...
##
DOMTestCase('HTMLHeadingElement03') do
  ...
  def test_HTMLHeadingElement03
    ...
    doc = load_document("heading", false)
      ...
      assert_equal("right", valign, "alignLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLHeadingElement03"
  end
end
