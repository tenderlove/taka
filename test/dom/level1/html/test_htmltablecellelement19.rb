...
##
DOMTestCase('HTMLTableCellElement19') do
  ...
  #
  def test_HTMLTableCellElement19
    nodeList = nil
    testNode = nil
    vheight = nil
    doc = nil
    doc = load_document("tablecell", false)
      ...
      assert_equal("50", vheight, "heightLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableCellElement19"
  end
end
