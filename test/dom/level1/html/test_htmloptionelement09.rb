...
##
DOMTestCase('HTMLOptionElement09') do
  ...
  def test_HTMLOptionElement09
    ...
    doc = load_document("option", false)
      ...
      assert_equal("10001", vvalue, "valueLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLOptionElement09"
  end
end
