...
##
DOMTestCase('HTMLLinkElement08') do
  ...
  def test_HTMLLinkElement08
    ...
    doc = load_document("link", false)
      ...
      vtype = testNode.type()
      assert_equal("text/html", vtype, "typeLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLLinkElement08"
  end
end
