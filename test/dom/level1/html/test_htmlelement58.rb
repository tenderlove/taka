...
DOMTestCase('HTMLElement58') do
  ...
  def test_HTMLElement58
    ...
    doc = load_document("element", false)
      ...
      assert_equal("CENTER Element", vtitle, "titleLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement58"
  end
end
