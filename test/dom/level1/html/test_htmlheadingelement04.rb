...
##
DOMTestCase('HTMLHeadingElement04') do
  ...
  def test_HTMLHeadingElement04
    ...
    doc = load_document("heading", false)
      ...
      assert_equal("justify", valign, "alignLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLHeadingElement04"
  end
end
