...
DOMTestCase('HTMLElement124') do
  ...
  def test_HTMLElement124
    ...
    doc = load_document("element", false)
      ...
      assert_equal("B-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement124"
  end
end
