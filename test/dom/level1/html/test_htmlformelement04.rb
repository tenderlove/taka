...
##
DOMTestCase('HTMLFormElement04') do
  ...
  def test_HTMLFormElement04
    ...
    doc = load_document("form", false)
      ...
      assert_equal("US-ASCII", vacceptcharset, "acceptCharsetLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLFormElement04"
  end
end
