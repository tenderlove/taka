...
##
DOMTestCase('HTMLCollection01') do
  ...
  def test_HTMLCollection01
    ...
    doc = load_document("collection", false)
      ...
      assert_equal(0, vrowindex, "rowIndexLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLCollection01"
  end
end
