...
##
DOMTestCase('HTMLLinkElement09') do
  ...
  #
  def test_HTMLLinkElement09
    nodeList = nil
    testNode = nil
    vtarget = nil
    doc = nil
    doc = load_document("link2", false)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLLinkElement09"
  end
end
