...
##
DOMTestCase('HTMLScriptElement05') do
  ...
  def test_HTMLScriptElement05
    ...
    doc = load_document("script", false)
      ...
      vtype = testNode.type()
      assert_equal("text/javaScript", vtype, "typeLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLScriptElement05"
  end
end
