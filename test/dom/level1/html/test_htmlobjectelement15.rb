...
##
DOMTestCase('HTMLObjectElement15') do
  ...
  def test_HTMLObjectElement15
    ...
    doc = load_document("object", false)
      ...
      assert_equal("#DivLogo-map", vusemap, "useMapLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLObjectElement15"
  end
end
