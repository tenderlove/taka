...
##
DOMTestCase('HTMLTitleElement01') do
  ...
  #
  def test_HTMLTitleElement01
    nodeList = nil
    testNode = nil
    vtext = nil
    doc = nil
    doc = load_document("title", false)
      nodeList = doc.getElementsByTagName("title")
      assertSize("Asize", 1, nodeList)
      testNode = nodeList.item(0)
      vtext = testNode.text()
      assert_equal("NIST DOM HTML Test - TITLE", vtext, "textLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTitleElement01"
  end
end
