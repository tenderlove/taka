...
##
DOMTestCase('HTMLInputElement01') do
  ...
  def test_HTMLInputElement01
    ...
    doc = load_document("input", false)
      ...
      assert_equal("Password", vdefaultvalue, "defaultValueLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLInputElement01"
  end
end
