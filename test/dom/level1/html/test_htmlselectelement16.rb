...
##
DOMTestCase('HTMLSelectElement16') do
  ...
  def test_HTMLSelectElement16
    ...
    doc = load_document("select", true)
      ...
      assert_equal(4, optLength, "optLength")
            selected = testNode.selectedIndex()
      assert_equal(-1, selected, "selected")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLSelectElement16"
  end
end
