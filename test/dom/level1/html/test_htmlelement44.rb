...
DOMTestCase('HTMLElement44') do
  ...
  def test_HTMLElement44
    ...
    doc = load_document("element", false)
      ...
      assert_equal("STRONG Element", vtitle, "titleLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement44"
  end
end
