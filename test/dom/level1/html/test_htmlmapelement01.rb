...
##
DOMTestCase('HTMLMapElement01') do
  ...
  def test_HTMLMapElement01
    ...
    doc = load_document("map", false)
      ...
      assert_equal(3, vareas, "areasLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLMapElement01"
  end
end
