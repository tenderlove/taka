...
##
DOMTestCase('HTMLImageElement08') do
  ...
  def test_HTMLImageElement08
    ...
    doc = load_document("img", false)
      ...
      assertURIEquals("longDescLink", nil, nil, nil, "desc.html", nil, nil, nil, nil, vlongdesc)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLImageElement08"
  end
end
