...
##
DOMTestCase('HTMLAppletElement11') do
  ...
  #
  def test_HTMLAppletElement11
    nodeList = nil
    testNode = nil
    vobject = nil
    doc = nil
    doc = load_document("applet2", false)
      nodeList = doc.getElementsByTagName("applet")
      assertSize("Asize", 1, nodeList)
      testNode = nodeList.item(0)
      vobject = testNode.object()
      assert_equal("DOMTSApplet.dat", vobject, "object")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLAppletElement11"
  end
end
