...
DOMTestCase('HTMLElement139') do
  ...
  def test_HTMLElement139
    ...
    doc = load_document("element", false)
      ...
      assert_equal("ABBR-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement139"
  end
end
