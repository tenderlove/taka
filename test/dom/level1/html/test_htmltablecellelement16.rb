...
##
DOMTestCase('HTMLTableCellElement16') do
  ...
  #
  def test_HTMLTableCellElement16
    nodeList = nil
    testNode = nil
    vcolspan = nil
    doc = nil
    doc = load_document("tablecell", false)
      ...
      assert_equal(1, vcolspan, "colSpanLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableCellElement16"
  end
end
