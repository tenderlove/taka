...
##
DOMTestCase('HTMLObjectElement05') do
  ...
  def test_HTMLObjectElement05
    ...
    doc = load_document("object", false)
      ...
      assert_equal("0", vborder, "borderLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLObjectElement05"
  end
end
