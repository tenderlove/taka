...
DOMTestCase('HTMLElement33') do
  ...
  def test_HTMLElement33
    ...
    doc = load_document("element", false)
      ...
      assert_equal("SPAN Element", vtitle, "titleLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement33"
  end
end
