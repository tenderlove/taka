...
##
DOMTestCase('HTMLAppletElement05') do
  ...
  def test_HTMLAppletElement05
    ...
    doc = load_document("applet", false)
      ...
      assert_equal("applets", vcodebase, "codebase")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLAppletElement05"
  end
end
