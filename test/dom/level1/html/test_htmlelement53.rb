...
DOMTestCase('HTMLElement53') do
  ...
  def test_HTMLElement53
    ...
    doc = load_document("element", false)
      ...
      assert_equal("DD Element", vtitle, "titleLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement53"
  end
end
