...
##
DOMTestCase('HTMLObjectElement13') do
  ...
  def test_HTMLObjectElement13
    ...
    doc = load_document("object", false)
      ...
      assert_equal(0, vtabindex, "tabIndexLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLObjectElement13"
  end
end
