...
##
DOMTestCase('HTMLIsIndexElement03') do
  ...
  def test_HTMLIsIndexElement03
    ...
    doc = load_document("isindex", false)
      ...
      assert_equal("New Employee: ", vprompt, "promptLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLIsIndexElement03"
  end
end
