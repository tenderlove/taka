...
##
DOMTestCase('HTMLTableRowElement10') do
  ...
  #
  def test_HTMLTableRowElement10
    nodeList = nil
    testNode = nil
    vvalign = nil
    doc = nil
    doc = load_document("tablerow", false)
      ...
      assert_equal("middle", vvalign, "vAlignLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableRowElement10"
  end
end
