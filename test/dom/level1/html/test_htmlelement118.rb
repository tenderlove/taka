...
DOMTestCase('HTMLElement118') do
  ...
  def test_HTMLElement118
    ...
    doc = load_document("element", false)
      ...
      assert_equal("SUB-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement118"
  end
end
