...
##
DOMTestCase('HTMLAreaElement07') do
  ...
  def test_HTMLAreaElement07
    ...
    doc = load_document("area", false)
      ...
      assert_equal(10, vtabindex, "tabIndexLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLAreaElement07"
  end
end
