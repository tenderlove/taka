...
##
DOMTestCase('HTMLTextAreaElement04') do
  ...
  #
  def test_HTMLTextAreaElement04
    nodeList = nil
    testNode = nil
    vaccesskey = nil
    doc = nil
    doc = load_document("textarea", false)
      ...
      assert_equal("c", vaccesskey, "accessKeyLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTextAreaElement04"
  end
end
