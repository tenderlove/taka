...
##
DOMTestCase('HTMLTableRowElement05') do
  ...
  #
  def test_HTMLTableRowElement05
    nodeList = nil
    cellsnodeList = nil
    testNode = nil
    vcells = nil
    ...
    doc = load_document("tablerow", false)
      ...
      assert_equal(6, vcells, "cellsLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableRowElement05"
  end
end
