...
##
DOMTestCase('HTMLTableElement12') do
  ...
  def test_HTMLTableElement12
    ...
    doc = load_document("table", false)
      ...
      assert_equal("4", vborder, "borderLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableElement12"
  end
end
