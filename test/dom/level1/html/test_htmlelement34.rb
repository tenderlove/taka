...
DOMTestCase('HTMLElement34') do
  ...
  def test_HTMLElement34
    ...
    doc = load_document("element", false)
      ...
      assert_equal("BDO Element", vtitle, "titleLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement34"
  end
end
