...
##
DOMTestCase('HTMLFormElement05') do
  ...
  def test_HTMLFormElement05
    ...
    doc = load_document("form", false)
      ...
      assertURIEquals("actionLink", nil, nil, nil, "getData.pl", nil, nil, nil, nil, vaction)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLFormElement05"
  end
end
