...
##
DOMTestCase('HTMLFieldSetElement01') do
  ...
  #
  def test_HTMLFieldSetElement01
    nodeList = nil
    testNode = nil
    vform = nil
    fNode = nil
    doc = nil
    doc = load_document("fieldset", false)
      nodeList = doc.getElementsByTagName("fieldset")
      assertSize("Asize", 2, nodeList)
      testNode = nodeList.item(0)
      fNode = testNode.form()
      vform = fNode.id()
      assert_equal("form2", vform, "formLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLFieldSetElement01"
  end
end
