...
##
DOMTestCase('HTMLTableRowElement14') do
  ...
  #
  def test_HTMLTableRowElement14
    nodeList = nil
    cellsnodeList = nil
    testNode = nil
    trNode = nil
    ...
    doc = load_document("tablerow", true)
      ...
      assert_equal("Accountant", value, "value1Link")
      ...
      cellNode = trNode.firstChild()
      value = cellNode.nodeValue()
      assert_equal("56,000", value, "value2Link")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableRowElement14"
  end
end
