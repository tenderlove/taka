...
DOMTestCase('HTMLElement142') do
  ...
  def test_HTMLElement142
    ...
    doc = load_document("element", false)
      ...
      assert_equal("NOFRAMES-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement142"
  end
end
