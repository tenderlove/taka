...
DOMTestCase('HTMLElement30') do
  ...
  def test_HTMLElement30
    ...
    doc = load_document("element", false)
      ...
      assert_equal("HEAD Element", vtitle, "titleLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement30"
  end
end
