...
DOMTestCase('HTMLElement131') do
  ...
  def test_HTMLElement131
    ...
    doc = load_document("element", false)
      ...
      assert_equal("STRONG-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement131"
  end
end
