...
##
DOMTestCase('HTMLAppletElement04') do
  ...
  def test_HTMLAppletElement04
    ...
    doc = load_document("applet", false)
      ...
      vcode = testNode.code()
      assert_equal("org/w3c/domts/DOMTSApplet.class", vcode, "codeLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLAppletElement04"
  end
end
