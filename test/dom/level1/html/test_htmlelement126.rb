...
DOMTestCase('HTMLElement126') do
  ...
  def test_HTMLElement126
    ...
    doc = load_document("element", false)
      ...
      assert_equal("S-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement126"
  end
end
