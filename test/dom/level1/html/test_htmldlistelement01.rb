...
##
DOMTestCase('HTMLDlistElement01') do
  ...
  #
  def test_HTMLDlistElement01
    nodeList = nil
    testNode = nil
    vcompact = nil
    doc = nil
    doc = load_document("dl", false)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLDlistElement01"
  end
end
