...
##
DOMTestCase('HTMLFrameElement08') do
  ...
  def test_HTMLFrameElement08
    ...
    doc = load_document("frame", false)
      ...
      vsrc = testNode.src()
      assertURIEquals("srcLink", nil, nil, nil, nil, "right", nil, nil, nil, vsrc)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLFrameElement08"
  end
end
