...
DOMTestCase('HTMLElement52') do
  ...
  def test_HTMLElement52
    ...
    doc = load_document("element", false)
      ...
      assert_equal("ABBR Element", vtitle, "titleLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement52"
  end
end
