...
##
DOMTestCase('HTMLCollection09') do
  ...
  def test_HTMLCollection09
    ...
    doc = load_document("collection", false)
      ...
      assert_nil(rowNode, "rowIndexLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLCollection09"
  end
end
