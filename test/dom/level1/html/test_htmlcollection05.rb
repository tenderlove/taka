...
##
DOMTestCase('HTMLCollection05') do
  ...
  def test_HTMLCollection05
    ...
    doc = load_document("collection", false)
      ...
      assert_equal(4, rowLength, "rowIndexLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLCollection05"
  end
end
