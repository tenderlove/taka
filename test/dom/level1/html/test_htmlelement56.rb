...
DOMTestCase('HTMLElement56') do
  ...
  def test_HTMLElement56
    ...
    doc = load_document("element", false)
      ...
      assert_equal("NOSCRIPT Element", vtitle, "titleLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement56"
  end
end
