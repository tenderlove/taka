...
##
DOMTestCase('HTMLAnchorElement01') do
  ...
  def test_HTMLAnchorElement01
    ...
    doc = load_document("anchor", false)
      ...
      assert_equal("g", vaccesskey, "accessKeyLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLAnchorElement01"
  end
end
