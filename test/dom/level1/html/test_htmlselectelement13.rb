...
##
DOMTestCase('HTMLSelectElement13') do
  ...
  def test_HTMLSelectElement13
    ...
    doc = load_document("select", false)
      ...
      assert_equal(7, vtabindex, "tabIndexLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLSelectElement13"
  end
end
