...
##
DOMTestCase('HTMLOptGroupElement02') do
  ...
  #
  def test_HTMLOptGroupElement02
    nodeList = nil
    testNode = nil
    vlabel = nil
    doc = nil
    doc = load_document("optgroup", false)
      nodeList = doc.getElementsByTagName("optgroup")
      assertSize("Asize", 2, nodeList)
      testNode = nodeList.item(0)
      vlabel = testNode.label()
      assert_equal("Regular Employees", vlabel, "labelLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLOptGroupElement02"
  end
end
