...
##
DOMTestCase('HTMLLinkElement02') do
  ...
  def test_HTMLLinkElement02
    ...
    doc = load_document("link", false)
      ...
      assert_equal("Latin-1", vcharset, "charsetLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLLinkElement02"
  end
end
