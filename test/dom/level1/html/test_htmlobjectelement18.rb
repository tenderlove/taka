...
##
DOMTestCase('HTMLObjectElement18') do
  ...
  def test_HTMLObjectElement18
    ...
    doc = load_document("object", false)
      ...
      vname = testNode.name()
      assert_equal("OBJECT2", vname, "vspaceLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLObjectElement18"
  end
end
