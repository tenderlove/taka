...
##
DOMTestCase('HTMLTableCellElement03') do
  ...
  #
  def test_HTMLTableCellElement03
    nodeList = nil
    testNode = nil
    vabbr = nil
    doc = nil
    doc = load_document("tablecell", false)
      ...
      vabbr = testNode.abbr()
      assert_equal("hd1", vabbr, "abbrLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTableCellElement03"
  end
end
