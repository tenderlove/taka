...
##
DOMTestCase('HTMLTextAreaElement05') do
  ...
  #
  def test_HTMLTextAreaElement05
    nodeList = nil
    testNode = nil
    vcols = nil
    doc = nil
    doc = load_document("textarea", false)
      ...
      vcols = testNode.cols()
      assert_equal(20, vcols, "colsLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTextAreaElement05"
  end
end
