...
##
DOMTestCase('HTMLAnchorElement11') do
  ...
  #
  def test_HTMLAnchorElement11
    nodeList = nil
    testNode = nil
    vtarget = nil
    doc = nil
    doc = load_document("anchor2", false)
      nodeList = doc.getElementsByTagName("a")
      assertSize("Asize", 1, nodeList)
      testNode = nodeList.item(0)
      vtarget = testNode.target()
      assert_equal("dynamic", vtarget, "targetLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLAnchorElement11"
  end
end
