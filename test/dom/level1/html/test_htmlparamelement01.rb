...
##
DOMTestCase('HTMLParamElement01') do
  ...
  def test_HTMLParamElement01
    ...
    doc = load_document("param", false)
      ...
      vname = testNode.name()
      assert_equal("image3", vname, "nameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLParamElement01"
  end
end
