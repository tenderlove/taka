...
##
DOMTestCase('HTMLOptionElement07') do
  ...
  def test_HTMLOptionElement07
    ...
    doc = load_document("option", false)
      ...
      assert_equal("l1", vlabel, "labelLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLOptionElement07"
  end
end
