...
##
DOMTestCase('HTMLLinkElement03') do
  ...
  def test_HTMLLinkElement03
    ...
    doc = load_document("link", false)
      ...
      vhref = testNode.href()
      assertURIEquals("hrefLink", nil, nil, nil, "glossary.html", nil, nil, nil, nil, vhref)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLLinkElement03"
  end
end
