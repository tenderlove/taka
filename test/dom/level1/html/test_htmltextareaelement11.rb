...
##
DOMTestCase('HTMLTextAreaElement11') do
  ...
  #
  def test_HTMLTextAreaElement11
    nodeList = nil
    testNode = nil
    vtype = nil
    doc = nil
    doc = load_document("textarea", false)
      ...
      vtype = testNode.type()
      assert_equal("textarea", vtype, "typeLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLTextAreaElement11"
  end
end
