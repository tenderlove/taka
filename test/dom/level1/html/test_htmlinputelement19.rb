...
##
DOMTestCase('HTMLInputElement19') do
  ...
  #
  def test_HTMLInputElement19
    nodeList = nil
    testNode = nil
    doc = nil
    doc = load_document("input", true)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLInputElement19"
  end
end
