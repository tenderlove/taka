...
##
DOMTestCase('HTMLModElement04') do
  ...
  def test_HTMLModElement04
    ...
    doc = load_document("mod", false)
      ...
      assert_equal("January 2, 2002", vdatetime, "dateTimeLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLModElement04"
  end
end
