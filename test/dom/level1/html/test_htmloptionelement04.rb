...
##
DOMTestCase('HTMLOptionElement04') do
  ...
  def test_HTMLOptionElement04
    ...
    doc = load_document("option", false)
      ...
      vtext = testNode.text()
      assert_equal("EMP10002", vtext, "textLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLOptionElement04"
  end
end
