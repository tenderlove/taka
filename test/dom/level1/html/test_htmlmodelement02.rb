...
##
DOMTestCase('HTMLModElement02') do
  ...
  def test_HTMLModElement02
    ...
    doc = load_document("mod", false)
      ...
      assert_equal("January 1, 2002", vdatetime, "dateTimeLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLModElement02"
  end
end
