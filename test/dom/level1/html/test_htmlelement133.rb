...
DOMTestCase('HTMLElement133') do
  ...
  def test_HTMLElement133
    ...
    doc = load_document("element", false)
      ...
      assert_equal("CODE-class", vclassname, "classNameLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement133"
  end
end
