...
DOMTestCase('HTMLElement49') do
  ...
  def test_HTMLElement49
    ...
    doc = load_document("element", false)
      ...
      assert_equal("VAR Element", vtitle, "titleLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/level1/html/HTMLElement49"
  end
end
