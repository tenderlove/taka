...
##
DOMTestCase('hc_namednodemapwrongdocumenterr') do
  ...
  #
  def test_hc_namednodemapwrongdocumenterr
    doc1 = nil
    doc2 = nil
    elementList = nil
    testAddress = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_namednodemapwrongdocumenterr"
  end
end
