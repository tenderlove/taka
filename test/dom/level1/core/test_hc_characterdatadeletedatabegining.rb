...
##
DOMTestCase('hc_characterdatadeletedatabegining') do
  ...
  #
  def test_hc_characterdatadeletedatabegining
    doc = nil
    elementList = nil
    nameNode = nil
    child = nil
    ...
    doc = load_document("hc_staff", true)
      ...
      assert_equal("Dallas, Texas 98551", childData, "data")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_characterdatadeletedatabegining"
  end
end
