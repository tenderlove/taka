...
##
DOMTestCase('domimplementationfeaturenoversion') do
  ...
  #
  def test_domimplementationfeaturenoversion
    doc = nil
    domImpl = nil
    state = nil
...
assertTrue("hasXMLEmpty", state)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/domimplementationfeaturenoversion"
  end
end
