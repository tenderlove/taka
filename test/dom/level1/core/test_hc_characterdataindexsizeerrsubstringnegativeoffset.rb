...
##
DOMTestCase('hc_characterdataindexsizeerrsubstringnegativeoffset') do
...
=end
  ...
  #
  def test_hc_characterdataindexsizeerrsubstringnegativeoffset
    doc = nil
    elementList = nil
    nameNode = nil
    child = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_characterdataindexsizeerrsubstringnegativeoffset"
  end
end
