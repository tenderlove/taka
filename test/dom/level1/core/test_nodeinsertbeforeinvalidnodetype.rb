...
##
DOMTestCase('nodeinsertbeforeinvalidnodetype') do
  ...
  #
  def test_nodeinsertbeforeinvalidnodetype
    doc = nil
    rootNode = nil
    newChild = nil
    elementList = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodeinsertbeforeinvalidnodetype"
  end
end
