...
##
DOMTestCase('nodegetnextsibling') do
  ...
  def test_nodegetnextsibling
    ...
    doc = load_document("staff", false)
      ...
      nsName = nsNode.nodeName()
       ...
       assert_equal("name", nsName, "nodeName")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodegetnextsibling"
  end
end
