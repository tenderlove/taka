...
##
DOMTestCase('hc_attrinsertbefore3') do
  ...
  def test_hc_attrinsertbefore3
    ...
    doc = load_document("hc_staff", true)
      ...
      assert_equal("Yes", value, "firstChildValue")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_attrinsertbefore3"
  end
end
