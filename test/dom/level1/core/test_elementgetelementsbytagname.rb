...
##
DOMTestCase('elementgetelementsbytagname') do
  ...
  #
  def test_elementgetelementsbytagname
    doc = nil
    elementList = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/elementgetelementsbytagname"
  end
end
