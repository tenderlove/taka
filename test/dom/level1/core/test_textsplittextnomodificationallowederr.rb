...
# see[http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001/level-one-core#ID-38853C1D]
##
DOMTestCase('textsplittextnomodificationallowederr') do
  ...
  #
  def test_textsplittextnomodificationallowederr
    doc = nil
    genderList = nil
    gender = nil
    entRef = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/textsplittextnomodificationallowederr"
  end
end
