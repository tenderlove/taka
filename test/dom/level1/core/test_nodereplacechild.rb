...
##
DOMTestCase('nodereplacechild') do
  ...
  def test_nodereplacechild
    ...
    doc = load_document("staff", true)
      ...
      assert_equal("newChild", childName, "nodeReplaceChildAssert1")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodereplacechild"
  end
end
