...
##
DOMTestCase('hc_nodegetnextsiblingnull') do
  ...
  #
  def test_hc_nodegetnextsiblingnull
    doc = nil
    elementList = nil
    employeeNode = nil
    lcNode = nil
    ...
    doc = load_document("hc_staff", false)
      ...
      assert_nil(nsNode, "nodeGetNextSiblingNullAssert1")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_nodegetnextsiblingnull"
  end
end
