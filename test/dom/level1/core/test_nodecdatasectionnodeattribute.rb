...
##
DOMTestCase('nodecdatasectionnodeattribute') do
  ...
  #
  def test_nodecdatasectionnodeattribute
    doc = nil
    elementList = nil
    cdataName = nil
    cdataNode = nil
    ...
    doc = load_document("staff", false)
      ...
      assert_nil(attrList, "cdataSection")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodecdatasectionnodeattribute"
  end
end
