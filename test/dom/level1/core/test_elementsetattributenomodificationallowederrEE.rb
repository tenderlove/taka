...
##
DOMTestCase('elementsetattributenomodificationallowederrEE') do
  ...
  #
  def test_elementsetattributenomodificationallowederrEE
    doc = nil
    genderList = nil
    gender = nil
    entRef = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/elementsetattributenomodificationallowederrEE"
  end
end
