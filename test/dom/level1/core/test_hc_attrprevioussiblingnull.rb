...
##
DOMTestCase('hc_attrprevioussiblingnull') do
  ...
  #
  def test_hc_attrprevioussiblingnull
    doc = nil
    addressList = nil
    testNode = nil
    attributes = nil
    ...
    doc = load_document("hc_staff", false)
      ...
      assert_nil(s, "attrPreviousSiblingNullAssert")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_attrprevioussiblingnull"
  end
end
