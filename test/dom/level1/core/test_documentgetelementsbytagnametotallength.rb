...
##
DOMTestCase('documentgetelementsbytagnametotallength') do
  ...
  #
  def test_documentgetelementsbytagnametotallength
    doc = nil
    nameList = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/documentgetelementsbytagnametotallength"
  end
end
