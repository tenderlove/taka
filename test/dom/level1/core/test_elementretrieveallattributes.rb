...
##
DOMTestCase('elementretrieveallattributes') do
...
=end
  ...
  #
  def test_elementretrieveallattributes
    doc = nil
    addressList = nil
    testAddress = nil
    attributes = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/elementretrieveallattributes"
  end
end
