...
##
DOMTestCase('nodeinsertbeforenodeancestor') do
  ...
  #
  def test_nodeinsertbeforenodeancestor
    doc = nil
    newChild = nil
    elementList = nil
    employeeNode = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodeinsertbeforenodeancestor"
  end
end
