...
##
DOMTestCase('nodegetfirstchildnull') do
  ...
  #
  def test_nodegetfirstchildnull
    doc = nil
    elementList = nil
    employeeNode = nil
    employeeList = nil
    ...
    doc = load_document("staff", false)
      ...
      assert_nil(noChildNode, "nodeGetFirstChildNullAssert1")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodegetfirstchildnull"
  end
end
