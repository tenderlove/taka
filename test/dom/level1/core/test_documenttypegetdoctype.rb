...
##
DOMTestCase('documenttypegetdoctype') do
  ...
  #
  def test_documenttypegetdoctype
    doc = nil
    docType = nil
    name = nil
    doc = load_document("staff", false)
      ...
      if (("image/svg+xml" == getContentType()))
        assert_equal("svg", name, "doctypeName")
            
          else
            assert_equal("staff", name, "documenttypeGetDocTypeAssert")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/documenttypegetdoctype"
  end
end
