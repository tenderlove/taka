...
##
DOMTestCase('nodegetlastchild') do
  ...
  def test_nodegetlastchild
    ...
    doc = load_document("staff", false)
      ...
      childName = lchildNode.nodeName()
       ...
       assert_equal("address", childName, "nodeName")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodegetlastchild"
  end
end
