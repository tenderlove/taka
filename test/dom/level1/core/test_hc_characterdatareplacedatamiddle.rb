...
##
DOMTestCase('hc_characterdatareplacedatamiddle') do
  ...
  #
  def test_hc_characterdatareplacedatamiddle
    doc = nil
    elementList = nil
    nameNode = nil
    child = nil
    ...
    doc = load_document("hc_staff", true)
      ...
      assert_equal("1230 South Ave. Dallas, Texas 98551", childData, "characterdataReplaceDataMiddleAssert")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_characterdatareplacedatamiddle"
  end
end
