...
##
DOMTestCase('hc_characterdataindexsizeerrsubstringoffsetgreater') do
  ...
  #
  def test_hc_characterdataindexsizeerrsubstringoffsetgreater
    doc = nil
    elementList = nil
    nameNode = nil
    child = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_characterdataindexsizeerrsubstringoffsetgreater"
  end
end
