...
##
DOMTestCase('elementretrievetagname') do
  ...
  #
  def test_elementretrievetagname
    doc = nil
    elementList = nil
    testEmployee = nil
    name = nil
    doc = load_document("staff", false)
      ...
      assert_equal("position", name, "nodename")
            name = testEmployee.tagName()
      assert_equal("position", name, "tagname")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/elementretrievetagname"
  end
end
