...
##
DOMTestCase('hc_nodeattributenodevalue') do
  ...
  #
  def test_hc_nodeattributenodevalue
    doc = nil
    elementList = nil
    testAddr = nil
    addrAttr = nil
    ...
    doc = load_document("hc_staff", false)
      ...
      assert_equal("Yes", attrValue, "nodeValue")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_nodeattributenodevalue"
  end
end
