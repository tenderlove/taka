...
##
DOMTestCase('characterdatainsertdatanomodificationallowederrEE') do
  ...
  #
  def test_characterdatainsertdatanomodificationallowederrEE
    doc = nil
    genderList = nil
    genderNode = nil
    entText = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/characterdatainsertdatanomodificationallowederrEE"
  end
end
