...
##
DOMTestCase('nodedocumentnodevalue') do
  ...
  #
  def test_nodedocumentnodevalue
    doc = nil
    documentValue = nil
    doc = load_document("staff", false)
      documentValue = doc.nodeValue()
      assert_nil(documentValue, "documentNodeValueNull")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodedocumentnodevalue"
  end
end
