...
##
DOMTestCase('nodereplacechildnodename') do
  ...
  #
  def test_nodereplacechildnodename
    doc = nil
    elementList = nil
    employeeNode = nil
    childList = nil
    ...
    doc = load_document("staff", true)
      ...
      if (equals(6, length))
        assert_equal("name", childName, "nowhitespace")
            
          else
            assert_equal("employeeId", childName, "whitespace")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodereplacechildnodename"
  end
end
