...
# see[http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001/level-one-core#ID-184E7107]
##
DOMTestCase('hc_nodeappendchildnodeancestor') do
  ...
  #
  def test_hc_nodeappendchildnodeancestor
    doc = nil
    newChild = nil
    elementList = nil
    employeeNode = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_nodeappendchildnodeancestor"
  end
end
