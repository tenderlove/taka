...
DOMTestCase('nodevalue09') do
  ...
  def test_nodevalue09
    ...
    doc = load_document("staff", true)
      ...
      assert_equal("DATA", newValue, "initial")
            newNode.nodeValue = "This should have an effect"
      newValue = newNode.nodeValue()
      assert_equal("This should have an effect", newValue, "after")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodevalue09"
  end
end
