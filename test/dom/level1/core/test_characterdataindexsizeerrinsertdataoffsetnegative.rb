...
##
DOMTestCase('characterdataindexsizeerrinsertdataoffsetnegative') do
...
=end
  ...
  #
  def test_characterdataindexsizeerrinsertdataoffsetnegative
    doc = nil
    elementList = nil
    nameNode = nil
    child = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/characterdataindexsizeerrinsertdataoffsetnegative"
  end
end
