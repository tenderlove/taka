...
# see[http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001/level-one-core#ID-785887307]
##
DOMTestCase('nodereplacechildnomodificationallowederr') do
  ...
  #
  def test_nodereplacechildnomodificationallowederr
    doc = nil
    genderList = nil
    genderNode = nil
    entRef = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodereplacechildnomodificationallowederr"
  end
end
