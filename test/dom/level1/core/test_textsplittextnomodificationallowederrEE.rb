...
##
DOMTestCase('textsplittextnomodificationallowederrEE') do
  ...
  #
  def test_textsplittextnomodificationallowederrEE
    doc = nil
    entRef = nil
    entText = nil
    splitNode = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/textsplittextnomodificationallowederrEE"
  end
end
