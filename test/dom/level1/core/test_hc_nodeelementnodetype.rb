...
##
DOMTestCase('hc_nodeelementnodetype') do
  ...
  #
  def test_hc_nodeelementnodetype
    doc = nil
    rootNode = nil
    nodeType = nil
    doc = load_document("hc_staff", false)
      ...
      assert_equal(1, nodeType, "nodeElementNodeTypeAssert1")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_nodeelementnodetype"
  end
end
