...
##
DOMTestCase('hc_nodedocumentnodename') do
  ...
  #
  def test_hc_nodedocumentnodename
    doc = nil
    documentName = nil
    doc = load_document("hc_staff", false)
      documentName = doc.nodeName()
      assert_equal("#document", documentName, "documentNodeName")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_nodedocumentnodename"
  end
end
