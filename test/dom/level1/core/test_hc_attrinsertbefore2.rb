...
##
DOMTestCase('hc_attrinsertbefore2') do
  ...
  def test_hc_attrinsertbefore2
    ...
    doc = load_document("hc_staff", true)
      ...
      assert_equal("terdayYes", value, "attrValue")
            value = titleAttr.nodeValue()
      assert_equal("terdayYes", value, "attrNodeValue")
            value = retval.nodeValue()
      assert_equal("terday", value, "retvalValue")
            firstChild = titleAttr.firstChild()
      value = firstChild.nodeValue()
      assert_equal("terday", value, "firstChildValue")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_attrinsertbefore2"
  end
end
