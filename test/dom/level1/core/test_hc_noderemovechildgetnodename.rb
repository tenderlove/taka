...
##
DOMTestCase('hc_noderemovechildgetnodename') do
  ...
  #
  def test_hc_noderemovechildgetnodename
    doc = nil
    elementList = nil
    employeeNode = nil
    childList = nil
    ...
    doc = load_document("hc_staff", true)
      ...
      assert_not_nil(removedChild, "notnull")
      childName = removedChild.nodeName()
      assert_equal(oldName, childName, "nodeName")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_noderemovechildgetnodename"
  end
end
