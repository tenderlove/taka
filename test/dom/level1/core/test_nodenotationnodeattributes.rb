...
##
DOMTestCase('nodenotationnodeattributes') do
  ...
  #
  def test_nodenotationnodeattributes
    doc = nil
    docType = nil
    notations = nil
    notationNode = nil
    ...
    doc = load_document("staff", false)
      ...
      assert_nil(attrList, "nodeNotationNodeAttributesAssert1")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodenotationnodeattributes"
  end
end
