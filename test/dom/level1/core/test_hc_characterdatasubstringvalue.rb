...
##
DOMTestCase('hc_characterdatasubstringvalue') do
  ...
  #
  def test_hc_characterdatasubstringvalue
    doc = nil
    elementList = nil
    nameNode = nil
    child = nil
    ...
    doc = load_document("hc_staff", false)
      ...
      assert_equal("Margaret", substring, "characterdataSubStringValueAssert")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_characterdatasubstringvalue"
  end
end
