...
##
DOMTestCase('nodeentitynodename') do
  ...
  def test_nodeentitynodename
    ...
    doc = load_document("staff", false)
      ...
      assert_not_nil(entityNode, "entityNodeNotNull")
      entityName = entityNode.nodeName()
      assert_equal("ent1", entityName, "entityNodeName")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodeentitynodename"
  end
end
