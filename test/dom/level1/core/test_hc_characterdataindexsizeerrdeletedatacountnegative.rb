...
##
DOMTestCase('hc_characterdataindexsizeerrdeletedatacountnegative') do
...
=end
  ...
  #
  def test_hc_characterdataindexsizeerrdeletedatacountnegative
    doc = nil
    elementList = nil
    nameNode = nil
    child = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_characterdataindexsizeerrdeletedatacountnegative"
  end
end
