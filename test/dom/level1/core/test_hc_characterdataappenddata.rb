...
##
DOMTestCase('hc_characterdataappenddata') do
  ...
  #
  def test_hc_characterdataappenddata
    doc = nil
    elementList = nil
    nameNode = nil
    child = nil
    ...
    doc = load_document("hc_staff", true)
      ...
      assert_equal(24, childLength, "characterdataAppendDataAssert")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_characterdataappenddata"
  end
end
