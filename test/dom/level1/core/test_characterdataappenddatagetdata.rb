...
##
DOMTestCase('characterdataappenddatagetdata') do
  ...
  #
  def test_characterdataappenddatagetdata
    doc = nil
    elementList = nil
    nameNode = nil
    child = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/characterdataappenddatagetdata"
  end
end
