...
##
DOMTestCase('hc_elementassociatedattribute') do
  ...
  #
  def test_hc_elementassociatedattribute
    doc = nil
    elementList = nil
    testEmployee = nil
    attributes = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_elementassociatedattribute"
  end
end
