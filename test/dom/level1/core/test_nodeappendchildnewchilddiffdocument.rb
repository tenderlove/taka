...
##
DOMTestCase('nodeappendchildnewchilddiffdocument') do
  ...
  #
  def test_nodeappendchildnewchilddiffdocument
    doc1 = nil
    doc2 = nil
    newChild = nil
    elementList = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodeappendchildnewchilddiffdocument"
  end
end
