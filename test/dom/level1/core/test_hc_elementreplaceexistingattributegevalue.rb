...
##
DOMTestCase('hc_elementreplaceexistingattributegevalue') do
  ...
  #
  def test_hc_elementreplaceexistingattributegevalue
    doc = nil
    elementList = nil
    testEmployee = nil
    newAttribute = nil
    ...
    doc = load_document("hc_staff", true)
      ...
      assert_not_nil(streetAttr, "previousAttrNotNull")
      value = streetAttr.value()
      assert_equal("No", value, "previousAttrValue")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_elementreplaceexistingattributegevalue"
  end
end
