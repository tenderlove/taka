...
##
DOMTestCase('namednodemapgetnameditem') do
  ...
  #
  def test_namednodemapgetnameditem
    doc = nil
    elementList = nil
    testEmployee = nil
    attributes = nil
    ...
    doc = load_document("staff", false)
      ...
      assert_equal("domestic", attrName, "namednodemapGetNamedItemAssert")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/namednodemapgetnameditem"
  end
end
