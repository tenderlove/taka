...
##
DOMTestCase('hc_characterdatainsertdataend') do
  ...
  #
  def test_hc_characterdatainsertdataend
    doc = nil
    elementList = nil
    nameNode = nil
    child = nil
    ...
    doc = load_document("hc_staff", true)
      ...
      assert_equal("Margaret Martin, Esquire", childData, "characterdataInsertDataEndAssert")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_characterdatainsertdataend"
  end
end
