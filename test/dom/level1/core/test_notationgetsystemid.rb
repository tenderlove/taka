...
##
DOMTestCase('notationgetsystemid') do
  ...
  def test_notationgetsystemid
    ...
    doc = load_document("staff", false)
      ...
      assertURIEquals("uriEquals", nil, nil, nil, "notation2File", nil, nil, nil, nil, systemId)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/notationgetsystemid"
  end
end
