...
##
DOMTestCase('hc_namednodemapreturnattrnode') do
  ...
  #
  def test_hc_namednodemapreturnattrnode
    doc = nil
    elementList = nil
    testEmployee = nil
    attributes = nil
...
attrName = streetAttr.nodeName()
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_namednodemapreturnattrnode"
  end
end
