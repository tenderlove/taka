...
##
DOMTestCase('nodedocumenttypenodename') do
  ...
  #
  def test_nodedocumenttypenodename
    doc = nil
    docType = nil
    ...
    doc = load_document("staff", false)
      ...
      if (("image/svg+xml" == getContentType()))
        assert_equal("svg", documentTypeName, "doctypeNameSVG")
            
          else
            assert_equal("staff", documentTypeName, "documentName")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodedocumenttypenodename"
  end
end
