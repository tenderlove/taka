...
##
DOMTestCase('namednodemapsetnameditemwithnewvalue') do
  ...
  #
  def test_namednodemapsetnameditemwithnewvalue
    doc = nil
    elementList = nil
    newAttribute = nil
    testAddress = nil
    ...
    doc = load_document("staff", true)
      ...
      assert_nil(newNode, "returnedNodeNull")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/namednodemapsetnameditemwithnewvalue"
  end
end
