...
##
DOMTestCase('namednodemapinuseattributeerr') do
  ...
  #
  def test_namednodemapinuseattributeerr
    doc = nil
    elementList = nil
    firstNode = nil
    testNode = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/namednodemapinuseattributeerr"
  end
end
