...
##
DOMTestCase('hc_characterdatadeletedataend') do
  ...
  #
  def test_hc_characterdatadeletedataend
    doc = nil
    elementList = nil
    nameNode = nil
    child = nil
    ...
    doc = load_document("hc_staff", true)
      ...
      assert_equal("1230 North Ave. Dallas, Texas ", childData, "characterdataDeleteDataEndAssert")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_characterdatadeletedataend"
  end
end
