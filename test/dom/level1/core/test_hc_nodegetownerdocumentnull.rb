...
##
DOMTestCase('hc_nodegetownerdocumentnull') do
  ...
  #
  def test_hc_nodegetownerdocumentnull
    doc = nil
    ownerDocument = nil
    doc = load_document("hc_staff", false)
      ownerDocument = doc.ownerDocument()
      assert_nil(ownerDocument, "nodeGetOwnerDocumentNullAssert1")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_nodegetownerdocumentnull"
  end
end
