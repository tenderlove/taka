...
##
DOMTestCase('hc_textsplittexttwo') do
  ...
  def test_hc_textsplittexttwo
    ...
    doc = load_document("hc_staff", true)
      ...
      assert_equal("Roger", value, "textSplitTextTwoAssert")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_textsplittexttwo"
  end
end
