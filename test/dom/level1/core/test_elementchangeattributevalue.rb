...
##
DOMTestCase('elementchangeattributevalue') do
  ...
  #
  def test_elementchangeattributevalue
    doc = nil
    elementList = nil
    testEmployee = nil
    attrValue = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/elementchangeattributevalue"
  end
end
