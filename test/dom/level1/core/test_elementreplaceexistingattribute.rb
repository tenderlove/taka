...
# @author Mary Brady
##
DOMTestCase('elementreplaceexistingattribute') do
  ...
  #
  def test_elementreplaceexistingattribute
    doc = nil
    elementList = nil
    testEmployee = nil
    newAttribute = nil
    ...
    doc = load_document("staff", true)
      ...
      assert_equal("", name, "elementReplaceExistingAttributeAssert")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/elementreplaceexistingattribute"
  end
end
