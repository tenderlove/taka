...
##
DOMTestCase('hc_namednodemapsetnameditemwithnewvalue') do
  ...
  #
  def test_hc_namednodemapsetnameditemwithnewvalue
    doc = nil
    elementList = nil
    newAttribute = nil
    testAddress = nil
    ...
    doc = load_document("hc_staff", true)
      ...
      assert_nil(newNode, "prevValueNull")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_namednodemapsetnameditemwithnewvalue"
  end
end
