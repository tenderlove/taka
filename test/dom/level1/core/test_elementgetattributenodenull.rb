...
##
DOMTestCase('elementgetattributenodenull') do
  ...
  #
  def test_elementgetattributenodenull
    doc = nil
    elementList = nil
    testEmployee = nil
    domesticAttr = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/elementgetattributenodenull"
  end
end
