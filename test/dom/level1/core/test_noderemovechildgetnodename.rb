...
##
DOMTestCase('noderemovechildgetnodename') do
  ...
  #
  def test_noderemovechildgetnodename
    doc = nil
    elementList = nil
    employeeNode = nil
    childList = nil
    ...
    doc = load_document("staff", true)
      ...
      if (equals(6, length))
        assert_equal("employeeId", childName, "nowhitespace")
            
          else
            assert_equal("#text", childName, "whitespace")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/noderemovechildgetnodename"
  end
end
