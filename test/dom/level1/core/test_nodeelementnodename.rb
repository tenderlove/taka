...
##
DOMTestCase('nodeelementnodename') do
    ...
    doc = load_document("staff", false)
      ...
      if (("image/svg+xml" == getContentType()))
        assert_equal("svg", elementName, "svgNodeName")
            ...
            assert_equal("staff", elementName, "nodeElementNodeNameAssert1")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodeelementnodename"
  end
end
