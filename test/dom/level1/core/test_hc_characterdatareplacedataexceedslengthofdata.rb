...
##
DOMTestCase('hc_characterdatareplacedataexceedslengthofdata') do
  ...
  #
  def test_hc_characterdatareplacedataexceedslengthofdata
    doc = nil
    elementList = nil
    nameNode = nil
    child = nil
    ...
    doc = load_document("hc_staff", true)
      ...
      assert_equal("2600", childData, "characterdataReplaceDataExceedsLengthOfDataAssert")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_characterdatareplacedataexceedslengthofdata"
  end
end
