...
##
DOMTestCase('elementremoveattributenode') do
  ...
  #
  def test_elementremoveattributenode
    doc = nil
    elementList = nil
    testEmployee = nil
    streetAttr = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/elementremoveattributenode"
  end
end
