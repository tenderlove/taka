...
##
DOMTestCase('hc_nodelistreturnfirstitem') do
  ...
  #
  def test_hc_nodelistreturnfirstitem
    doc = nil
    elementList = nil
    employeeNode = nil
    employeeList = nil
    ...
    doc = load_document("hc_staff", false)
      ...
      if (equals("#text", childName))
        assert_equal("#text", childName, "nodeName_w_space")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_nodelistreturnfirstitem"
  end
end
