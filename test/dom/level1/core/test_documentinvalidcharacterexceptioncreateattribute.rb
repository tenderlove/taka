...
##
DOMTestCase('documentinvalidcharacterexceptioncreateattribute') do
  ...
  #
  def test_documentinvalidcharacterexceptioncreateattribute
    doc = nil
    createdAttr = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/documentinvalidcharacterexceptioncreateattribute"
  end
end
