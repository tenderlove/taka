...
##
DOMTestCase('hc_elementwrongdocumenterr') do
  ...
  #
  def test_hc_elementwrongdocumenterr
    doc1 = nil
    doc2 = nil
    newAttribute = nil
    ...
    testAddress = nil
    attrAddress = nil
    doc1 = load_document("hc_staff", true)
      doc2 = load_document("hc_staff", false)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_elementwrongdocumenterr"
  end
end
