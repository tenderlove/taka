...
##
DOMTestCase('nodereplacechildinvalidnodetype') do
  ...
  #
  def test_nodereplacechildinvalidnodetype
    doc = nil
    rootNode = nil
    newChild = nil
    elementList = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodereplacechildinvalidnodetype"
  end
end
