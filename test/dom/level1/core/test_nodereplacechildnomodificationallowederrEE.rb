...
##
DOMTestCase('nodereplacechildnomodificationallowederrEE') do
  ...
  #
  def test_nodereplacechildnomodificationallowederrEE
    doc = nil
    entRef = nil
    entText = nil
    createdNode = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodereplacechildnomodificationallowederrEE"
  end
end
