...
##
DOMTestCase('hc_characterdatareplacedatabegining') do
  ...
  #
  def test_hc_characterdatareplacedatabegining
    doc = nil
    elementList = nil
    nameNode = nil
    child = nil
    ...
    doc = load_document("hc_staff", true)
      ...
      assert_equal("2500 North Ave. Dallas, Texas 98551", childData, "characterdataReplaceDataBeginingAssert")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_characterdatareplacedatabegining"
  end
end
