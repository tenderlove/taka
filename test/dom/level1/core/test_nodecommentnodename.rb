...
##
DOMTestCase('nodecommentnodename') do
  ...
  def test_nodecommentnodename
    ...
    doc = load_document("staff", false)
      ...
      indexid5529026 = 0
    while (indexid5529026 < elementList.length)
      commentNode = elementList.item(indexid5529026)
    nodeType = commentNode.nodeType()
      
      if (equals(8, nodeType))
        commentNodeName = commentNode.nodeName()
      assert_equal("#comment", commentNodeName, "commentNodeName")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodecommentnodename"
  end
end
