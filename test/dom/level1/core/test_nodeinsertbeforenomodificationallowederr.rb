...
# see[http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001/level-one-core#ID-952280727]
##
DOMTestCase('nodeinsertbeforenomodificationallowederr') do
  ...
  #
  def test_nodeinsertbeforenomodificationallowederr
    doc = nil
    genderList = nil
    genderNode = nil
    entRef = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodeinsertbeforenomodificationallowederr"
  end
end
