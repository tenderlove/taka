...
##
DOMTestCase('elementgetelementsbytagnamenomatch') do
  ...
  #
  def test_elementgetelementsbytagnamenomatch
    doc = nil
    elementList = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/elementgetelementsbytagnamenomatch"
  end
end
