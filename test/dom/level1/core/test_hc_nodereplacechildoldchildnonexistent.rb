...
##
DOMTestCase('hc_nodereplacechildoldchildnonexistent') do
  ...
  #
  def test_hc_nodereplacechildoldchildnonexistent
    doc = nil
    oldChild = nil
    newChild = nil
    elementList = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_nodereplacechildoldchildnonexistent"
  end
end
