...
##
DOMTestCase('noderemovechildnomodificationallowederrEE') do
  ...
  #
  def test_noderemovechildnomodificationallowederrEE
    doc = nil
    entRef = nil
    entText = nil
    removedNode = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/noderemovechildnomodificationallowederrEE"
  end
end
