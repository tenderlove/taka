...
##
DOMTestCase('nodegetprevioussibling') do
  ...
  #
  def test_nodegetprevioussibling
    doc = nil
    elementList = nil
    nameNode = nil
    psNode = nil
    ...
    doc = load_document("staff", false)
      ...
      psName = psNode.nodeName()
       ...
       assert_equal("employeeId", psName, "nodeName")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodegetprevioussibling"
  end
end
