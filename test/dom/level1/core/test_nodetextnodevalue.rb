...
##
DOMTestCase('nodetextnodevalue') do
  ...
  def test_nodetextnodevalue
    ...
    doc = load_document("staff", false)
      ...
      assert_equal("1230 North Ave. Dallas, Texas 98551", textValue, "nodeTextNodeValueAssert1")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodetextnodevalue"
  end
end
