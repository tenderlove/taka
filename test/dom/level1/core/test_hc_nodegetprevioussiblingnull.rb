...
##
DOMTestCase('hc_nodegetprevioussiblingnull') do
  ...
  #
  def test_hc_nodegetprevioussiblingnull
    doc = nil
    elementList = nil
    employeeNode = nil
    fcNode = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_nodegetprevioussiblingnull"
  end
end
