...
##
DOMTestCase('hc_nodedocumentnodevalue') do
  ...
  #
  def test_hc_nodedocumentnodevalue
    doc = nil
    documentValue = nil
    doc = load_document("hc_staff", false)
      documentValue = doc.nodeValue()
      assert_nil(documentValue, "documentNodeValue")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_nodedocumentnodevalue"
  end
end
