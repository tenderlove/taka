...
##
DOMTestCase('hc_attreffectivevalue') do
  ...
  #
  def test_hc_attreffectivevalue
    doc = nil
    addressList = nil
    testNode = nil
    attributes = nil
    ...
    doc = load_document("hc_staff", false)
      ...
      assert_equal("Yes", value, "attrEffectiveValueAssert")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_attreffectivevalue"
  end
end
