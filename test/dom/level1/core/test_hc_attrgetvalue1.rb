...
##
DOMTestCase('hc_attrgetvalue1') do
  ...
  def test_hc_attrgetvalue1
    ...
    doc = load_document("hc_staff", true)
      ...
      assert_equal("Yα", value, "attrValue1")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_attrgetvalue1"
  end
end
