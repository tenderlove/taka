...
##
DOMTestCase('hc_nodegetfirstchildnull') do
  ...
  #
  def test_hc_nodegetfirstchildnull
    doc = nil
    emList = nil
    emNode = nil
    emText = nil
    ...
    doc = load_document("hc_staff", false)
      ...
      assert_nil(nullChild, "nullChild")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_nodegetfirstchildnull"
  end
end
