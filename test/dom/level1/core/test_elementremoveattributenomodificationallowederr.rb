...
# see[http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001/level-one-core#ID-6D6AC0F9]
##
DOMTestCase('elementremoveattributenomodificationallowederr') do
  ...
  #
  def test_elementremoveattributenomodificationallowederr
    doc = nil
    genderList = nil
    gender = nil
    genList = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/elementremoveattributenomodificationallowederr"
  end
end
