...
##
DOMTestCase('hc_nodelisttraverselist') do
  ...
  #
  def test_hc_nodelisttraverselist
    doc = nil
    elementList = nil
    employeeNode = nil
    employeeList = nil
    ...
    doc = load_document("hc_staff", false)
      ...
      indexid4532665 = 0
    while (indexid4532665 < employeeList.length)
      child = employeeList.item(indexid4532665)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_nodelisttraverselist"
  end
end
