...
##
DOMTestCase('hc_nodereplacechildnewchilddiffdocument') do
  ...
  #
  def test_hc_nodereplacechildnewchilddiffdocument
    doc1 = nil
    doc2 = nil
    oldChild = nil
    newChild = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_nodereplacechildnewchilddiffdocument"
  end
end
