...
##
DOMTestCase('elementinvalidcharacterexception') do
  ...
  #
  def test_elementinvalidcharacterexception
    doc = nil
    elementList = nil
    testAddress = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/elementinvalidcharacterexception"
  end
end
