...
##
DOMTestCase('nodeprocessinginstructionnodename') do
  ...
  #
  def test_nodeprocessinginstructionnodename
    doc = nil
    testList = nil
    piNode = nil
    piName = nil
    doc = load_document("staff", false)
      ...
      assert_equal("TEST-STYLE", piName, "nodeProcessingInstructionNodeNameAssert1")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodeprocessinginstructionnodename"
  end
end
