...
##
DOMTestCase('hc_nodegetprevioussibling') do
  ...
  #
  def test_hc_nodegetprevioussibling
    doc = nil
    elementList = nil
    nameNode = nil
    psNode = nil
    ...
    doc = load_document("hc_staff", false)
      ...
      assert_equal("#text", psName, "whitespace")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_nodegetprevioussibling"
  end
end
