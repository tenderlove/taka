...
# see[http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001/level-one-core#ID-785887307]
##
DOMTestCase('nodereplacechildnewchilddiffdocument') do
  ...
  #
  def test_nodereplacechildnewchilddiffdocument
    doc1 = nil
    doc2 = nil
    oldChild = nil
    newChild = nil
    ...
    elementNode = nil
    replacedChild = nil
    doc1 = load_document("staff", false)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodereplacechildnewchilddiffdocument"
  end
end
