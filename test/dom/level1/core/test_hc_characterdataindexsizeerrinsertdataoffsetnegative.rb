...
##
DOMTestCase('hc_characterdataindexsizeerrinsertdataoffsetnegative') do
...
=end
  ...
  #
  def test_hc_characterdataindexsizeerrinsertdataoffsetnegative
    doc = nil
    elementList = nil
    nameNode = nil
    child = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_characterdataindexsizeerrinsertdataoffsetnegative"
  end
end
