...
# @author Curt Arnold
##
DOMTestCase('hc_elementreplaceexistingattribute') do
  ...
  #
  def test_hc_elementreplaceexistingattribute
    doc = nil
    elementList = nil
    testEmployee = nil
    newAttribute = nil
    ...
    doc = load_document("hc_staff", true)
      ...
      assert_equal("", strong, "replacedValue")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_elementreplaceexistingattribute"
  end
end
