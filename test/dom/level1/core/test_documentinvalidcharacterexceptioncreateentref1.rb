...
##
DOMTestCase('documentinvalidcharacterexceptioncreateentref1') do
  ...
  #
  def test_documentinvalidcharacterexceptioncreateentref1
    doc = nil
    badEntityRef = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/documentinvalidcharacterexceptioncreateentref1"
  end
end
