...
##
DOMTestCase('hc_documentgetdoctype') do
  ...
  #
  def test_hc_documentgetdoctype
    doc = nil
    docType = nil
    docTypeName = nil
    nodeValue = nil
    ...
    !(("text/html" == getContentType()))
      ...
      if (("image/svg+xml" == getContentType()))
        assert_equal("svg", docTypeName, "nodeNameSVG")
            
          else
            assert_equal("html", docTypeName, "nodeName")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_documentgetdoctype"
  end
end
