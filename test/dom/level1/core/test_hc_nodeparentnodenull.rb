...
##
DOMTestCase('hc_nodeparentnodenull') do
  ...
  #
  def test_hc_nodeparentnodenull
    doc = nil
    createdNode = nil
    parentNode = nil
    doc = load_document("hc_staff", false)
      ...
      assert_nil(parentNode, "parentNode")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_nodeparentnodenull"
  end
end
