...
##
DOMTestCase('hc_nodelistindexgetlengthofemptylist') do
  ...
  #
  def test_hc_nodelistindexgetlengthofemptylist
    doc = nil
    emList = nil
    emNode = nil
    textNode = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_nodelistindexgetlengthofemptylist"
  end
end
