...
##
DOMTestCase('nodetextnodeattribute') do
  ...
  #
  def test_nodetextnodeattribute
    doc = nil
    elementList = nil
    testAddr = nil
    textNode = nil
    ...
    doc = load_document("staff", false)
      ...
      assert_nil(attrList, "nodeTextNodeAttributesAssert1")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodetextnodeattribute"
  end
end
