...
##
DOMTestCase('hc_documentcreateattribute') do
  ...
  #
  def test_hc_documentcreateattribute
    doc = nil
    newAttrNode = nil
    attrValue = nil
    attrName = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_documentcreateattribute"
  end
end
