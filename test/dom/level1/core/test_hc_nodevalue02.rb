...
DOMTestCase('hc_nodevalue02') do
  ...
  def test_hc_nodevalue02
    ...
    doc = load_document("hc_staff", true)
      ...
      assert_equal("This is a new Comment node", newValue, "initial")
            newNode.nodeValue = "This should have an effect"
      newValue = newNode.nodeValue()
      assert_equal("This should have an effect", newValue, "afterChange")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_nodevalue02"
  end
end
