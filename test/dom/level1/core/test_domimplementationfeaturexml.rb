...
##
DOMTestCase('domimplementationfeaturexml') do
  ...
  #
  def test_domimplementationfeaturexml
    doc = nil
    domImpl = nil
    state = nil
...
assertTrue("hasXML1", state)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/domimplementationfeaturexml"
  end
end
