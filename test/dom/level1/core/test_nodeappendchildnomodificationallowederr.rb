...
# see[http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001/level-one-core#ID-184E7107]
##
DOMTestCase('nodeappendchildnomodificationallowederr') do
  ...
  #
  def test_nodeappendchildnomodificationallowederr
    doc = nil
    genderList = nil
    genderNode = nil
    entRef = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodeappendchildnomodificationallowederr"
  end
end
