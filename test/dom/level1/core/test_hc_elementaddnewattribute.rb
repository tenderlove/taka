...
##
DOMTestCase('hc_elementaddnewattribute') do
  ...
  #
  def test_hc_elementaddnewattribute
    doc = nil
    elementList = nil
    testEmployee = nil
    attrValue = nil
    doc = load_document("hc_staff", true)
      ...
      assert_equal("EN-us", attrValue, "attrValue")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_elementaddnewattribute"
  end
end
