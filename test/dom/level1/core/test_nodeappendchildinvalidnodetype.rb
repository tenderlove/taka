...
##
DOMTestCase('nodeappendchildinvalidnodetype') do
  ...
  #
  def test_nodeappendchildinvalidnodetype
    doc = nil
    rootNode = nil
    newChild = nil
    appendedChild = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodeappendchildinvalidnodetype"
  end
end
