...
##
DOMTestCase('hc_nodeattributenodetype') do
  ...
  #
  def test_hc_nodeattributenodetype
    doc = nil
    elementList = nil
    testAddr = nil
    addrAttr = nil
    ...
    doc = load_document("hc_staff", false)
      ...
      assert_equal(2, nodeType, "nodeAttrNodeTypeAssert1")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_nodeattributenodetype"
  end
end
