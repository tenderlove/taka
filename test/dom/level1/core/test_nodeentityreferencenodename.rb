...
##
DOMTestCase('nodeentityreferencenodename') do
  ...
  #
  def test_nodeentityreferencenodename
    doc = nil
    elementList = nil
    entRefAddr = nil
    entRefNode = nil
    ...
    doc = load_document("staff", false)
      ...
      assert_equal("ent2", entRefName, "nodeEntityReferenceNodeNameAssert1")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodeentityreferencenodename"
  end
end
