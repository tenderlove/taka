...
##
DOMTestCase('hc_documentgetelementsbytagnamelength') do
  ...
  #
  def test_hc_documentgetelementsbytagnamelength
    doc = nil
    nameList = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_documentgetelementsbytagnamelength"
  end
end
