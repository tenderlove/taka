...
##
DOMTestCase('nodedocumentfragmentnodetype') do
  ...
  #
  def test_nodedocumentfragmentnodetype
    doc = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodedocumentfragmentnodetype"
  end
end
