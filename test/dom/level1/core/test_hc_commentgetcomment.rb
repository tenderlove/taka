...
##
DOMTestCase('hc_commentgetcomment') do
  ...
  def test_hc_commentgetcomment
    ...
    doc = load_document("hc_staff", false)
      ...
      indexid2837591 = 0
    while (indexid2837591 < elementList.length)
      child = elementList.item(indexid2837591)
    childType = child.nodeType()
      
      if (equals(8, childType))
        childName = child.nodeName()
      assert_equal("#comment", childName, "nodeName")
            childValue = child.nodeValue()
      assert_equal(" This is comment number 1.", childValue, "nodeValue")
            attributes = child.attributes()
      assert_nil(attributes, "attributes")
      commentCount += 1
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_commentgetcomment"
  end
end
