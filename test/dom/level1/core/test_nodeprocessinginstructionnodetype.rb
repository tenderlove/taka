...
##
DOMTestCase('nodeprocessinginstructionnodetype') do
  ...
  #
  def test_nodeprocessinginstructionnodetype
    doc = nil
    testList = nil
    piNode = nil
    nodeType = nil
    doc = load_document("staff", false)
      ...
      assert_equal(7, nodeType, "nodeProcessingInstructionNodeTypeAssert1")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodeprocessinginstructionnodetype"
  end
end
