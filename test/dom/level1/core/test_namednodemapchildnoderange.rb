...
##
DOMTestCase('namednodemapchildnoderange') do
  ...
  #
  def test_namednodemapchildnoderange
    doc = nil
    elementList = nil
    testEmployee = nil
    attributes = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/namednodemapchildnoderange"
  end
end
