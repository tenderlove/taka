...
##
DOMTestCase('hc_attrnextsiblingnull') do
  ...
  #
  def test_hc_attrnextsiblingnull
    doc = nil
    addressList = nil
    testNode = nil
    attributes = nil
    ...
    doc = load_document("hc_staff", false)
      ...
      assert_nil(s, "attrNextSiblingNullAssert")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_attrnextsiblingnull"
  end
end
