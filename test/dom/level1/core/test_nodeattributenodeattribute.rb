...
##
DOMTestCase('nodeattributenodeattribute') do
  ...
  #
  def test_nodeattributenodeattribute
    doc = nil
    elementList = nil
    testAddr = nil
    addrAttr = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodeattributenodeattribute"
  end
end
