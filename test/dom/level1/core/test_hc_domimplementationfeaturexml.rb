...
##
DOMTestCase('hc_domimplementationfeaturexml') do
  ...
  #
  def test_hc_domimplementationfeaturexml
    doc = nil
    domImpl = nil
    state = nil
...
assertTrue("supports_xml_1.0", state)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_domimplementationfeaturexml"
  end
end
