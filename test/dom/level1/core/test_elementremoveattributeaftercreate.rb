...
##
DOMTestCase('elementremoveattributeaftercreate') do
  ...
  #
  def test_elementremoveattributeaftercreate
    doc = nil
    elementList = nil
    testEmployee = nil
    newAttribute = nil
    ...
    doc = load_document("staff", true)
      ...
      assert_nil(districtAttr, "elementRemoveAttributeAfterCreateAssert")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/elementremoveattributeaftercreate"
  end
end
