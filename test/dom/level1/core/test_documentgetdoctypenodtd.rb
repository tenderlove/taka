...
##
DOMTestCase('documentgetdoctypenodtd') do
...
=end
  ...
  #
  def test_documentgetdoctypenodtd
    doc = nil
    docType = nil
    doc = load_document("hc_nodtdstaff", false)
      docType = doc.doctype()
      assert_nil(docType, "documentGetDocTypeNoDTDAssert")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/documentgetdoctypenodtd"
  end
end
