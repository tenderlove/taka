...
##
DOMTestCase('documentcreateattribute') do
  ...
  #
  def test_documentcreateattribute
    doc = nil
    newAttrNode = nil
    attrValue = nil
    attrName = nil
    ...
    doc = load_document("staff", true)
      ...
      assert_equal("", attrValue, "value")
            attrName = newAttrNode.nodeName()
      assert_equal("district", attrName, "name")
            attrType = newAttrNode.nodeType()
      assert_equal(2, attrType, "type")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/documentcreateattribute"
  end
end
