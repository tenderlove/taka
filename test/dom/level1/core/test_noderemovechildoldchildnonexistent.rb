...
##
DOMTestCase('noderemovechildoldchildnonexistent') do
  ...
  #
  def test_noderemovechildoldchildnonexistent
    doc = nil
    oldChild = nil
    elementList = nil
    elementNode = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/noderemovechildoldchildnonexistent"
  end
end
