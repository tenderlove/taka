...
# see[http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001/level-one-core#ID-952280727]
##
DOMTestCase('nodeinsertbeforenewchilddiffdocument') do
  ...
  #
  def test_nodeinsertbeforenewchilddiffdocument
    doc1 = nil
    doc2 = nil
    refChild = nil
    newChild = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodeinsertbeforenewchilddiffdocument"
  end
end
