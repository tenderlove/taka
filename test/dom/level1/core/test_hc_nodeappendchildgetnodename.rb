...
##
DOMTestCase('hc_nodeappendchildgetnodename') do
  ...
  #
  def test_hc_nodeappendchildgetnodename
    doc = nil
    elementList = nil
    employeeNode = nil
    childList = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_nodeappendchildgetnodename"
  end
end
