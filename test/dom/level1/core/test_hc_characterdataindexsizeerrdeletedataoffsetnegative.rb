...
# see[http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001/level-one-core#ID-7C603781]
##
DOMTestCase('hc_characterdataindexsizeerrdeletedataoffsetnegative') do
...
=end
  ...
  #
  def test_hc_characterdataindexsizeerrdeletedataoffsetnegative
    doc = nil
    elementList = nil
    nameNode = nil
    child = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_characterdataindexsizeerrdeletedataoffsetnegative"
  end
end
