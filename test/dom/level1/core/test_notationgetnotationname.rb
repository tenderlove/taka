...
##
DOMTestCase('notationgetnotationname') do
  ...
  #
  def test_notationgetnotationname
    doc = nil
    docType = nil
    notations = nil
    notationNode = nil
    ...
    doc = load_document("staff", false)
      ...
      assert_equal("notation1", notationName, "notationGetNotationNameAssert")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/notationgetnotationname"
  end
end
