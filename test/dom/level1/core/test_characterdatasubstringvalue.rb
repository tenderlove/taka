...
##
DOMTestCase('characterdatasubstringvalue') do
  ...
  #
  def test_characterdatasubstringvalue
    doc = nil
    elementList = nil
    nameNode = nil
    child = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/characterdatasubstringvalue"
  end
end
