...
##
DOMTestCase('hc_elementretrieveattrvalue') do
  ...
  #
  def test_hc_elementretrieveattrvalue
    doc = nil
    elementList = nil
    testAddress = nil
    attrValue = nil
    doc = load_document("hc_staff", false)
      ...
      assert_equal("No", attrValue, "attrValue")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_elementretrieveattrvalue"
  end
end
