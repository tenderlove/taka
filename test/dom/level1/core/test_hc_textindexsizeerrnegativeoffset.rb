...
##
DOMTestCase('hc_textindexsizeerrnegativeoffset') do
...
=end
  ...
  #
  def test_hc_textindexsizeerrnegativeoffset
    doc = nil
    elementList = nil
    nameNode = nil
    textNode = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_textindexsizeerrnegativeoffset"
  end
end
