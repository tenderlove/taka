...
##
DOMTestCase('nodenotationnodetype') do
  ...
  def test_nodenotationnodetype
    ...
    doc = load_document("staff", false)
      ...
      assert_equal(12, nodeType, "nodeNotationNodeTypeAssert1")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodenotationnodetype"
  end
end
