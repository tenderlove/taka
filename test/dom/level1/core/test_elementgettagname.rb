...
##
DOMTestCase('elementgettagname') do
  ...
  def test_elementgettagname
    ...
    doc = load_document("staff", false)
      ...
      if (("image/svg+xml" == getContentType()))
        assert_equal("svg", tagname, "svgTagName")
            
          else
            assert_equal("staff", tagname, "elementGetTagNameAssert")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/elementgettagname"
  end
end
