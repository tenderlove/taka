...
##
DOMTestCase('hc_nodedocumentnodetype') do
  ...
  #
  def test_hc_nodedocumentnodetype
    doc = nil
    nodeType = nil
    doc = load_document("hc_staff", false)
      nodeType = doc.nodeType()
      assert_equal(9, nodeType, "nodeDocumentNodeTypeAssert1")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_nodedocumentnodetype"
  end
end
