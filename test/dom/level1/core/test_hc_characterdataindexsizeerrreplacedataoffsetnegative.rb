...
# see[http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001/level-one-core#ID-E5CBA7FB]
##
DOMTestCase('hc_characterdataindexsizeerrreplacedataoffsetnegative') do
...
=end
  ...
  #
  def test_hc_characterdataindexsizeerrreplacedataoffsetnegative
    doc = nil
    elementList = nil
    nameNode = nil
    child = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_characterdataindexsizeerrreplacedataoffsetnegative"
  end
end
