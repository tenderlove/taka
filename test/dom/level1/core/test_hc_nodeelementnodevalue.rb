...
##
DOMTestCase('hc_nodeelementnodevalue') do
  ...
  #
  def test_hc_nodeelementnodevalue
    doc = nil
    elementNode = nil
    elementValue = nil
    doc = load_document("hc_staff", false)
      ...
      assert_nil(elementValue, "elementNodeValue")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_nodeelementnodevalue"
  end
end
