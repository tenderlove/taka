...
##
DOMTestCase('hc_elementreplaceattributewithself') do
  ...
  #
  def test_hc_elementreplaceattributewithself
    doc = nil
    elementList = nil
    testEmployee = nil
    streetAttr = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_elementreplaceattributewithself"
  end
end
