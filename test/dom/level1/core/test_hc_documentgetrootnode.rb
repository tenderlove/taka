...
##
DOMTestCase('hc_documentgetrootnode') do
  ...
  #
  def test_hc_documentgetrootnode
    doc = nil
    root = nil
    rootName = nil
    doc = load_document("hc_staff", false)
      ...
      if (("image/svg+xml" == getContentType()))
        assert_equal("svg", rootName, "svgTagName")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_documentgetrootnode"
  end
end
