...
DOMTestCase('hc_nodevalue08') do
  ...
  def test_hc_nodevalue08
    ...
    !(("text/html" == getContentType()))
      ...
      assert_not_nil(newNode, "notationNotNull")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_nodevalue08"
  end
end
