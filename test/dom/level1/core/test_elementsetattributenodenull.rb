...
##
DOMTestCase('elementsetattributenodenull') do
  ...
  #
  def test_elementsetattributenodenull
    doc = nil
    elementList = nil
    testEmployee = nil
    newAttribute = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/elementsetattributenodenull"
  end
end
