...
DOMTestCase('hc_nodevalue06') do
  ...
  #
  def test_hc_nodevalue06
    newNode = nil
    newValue = nil
    newNode = load_document("hc_staff", true)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_nodevalue06"
  end
end
