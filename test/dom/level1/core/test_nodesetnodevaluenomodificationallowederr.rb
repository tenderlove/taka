...
# see[http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001/level-one-core#ID-F68D080]
##
DOMTestCase('nodesetnodevaluenomodificationallowederr') do
  ...
  #
  def test_nodesetnodevaluenomodificationallowederr
    doc = nil
    genderList = nil
    genderNode = nil
    entRef = nil
    ...
    doc = load_document("staff", true)
      ...
      assert_not_nil(entElementText, "entElementTextNotNull")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodesetnodevaluenomodificationallowederr"
  end
end
