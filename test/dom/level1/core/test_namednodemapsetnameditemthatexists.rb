...
##
DOMTestCase('namednodemapsetnameditemthatexists') do
  ...
  #
  def test_namednodemapsetnameditemthatexists
    doc = nil
    elementList = nil
    newAttribute = nil
    testAddress = nil
    ...
    doc = load_document("staff", true)
      ...
      assert_equal("", attrValue, "streetValue")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/namednodemapsetnameditemthatexists"
  end
end
