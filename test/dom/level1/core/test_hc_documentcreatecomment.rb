...
##
DOMTestCase('hc_documentcreatecomment') do
  ...
  #
  def test_hc_documentcreatecomment
    doc = nil
    newCommentNode = nil
    newCommentValue = nil
    newCommentName = nil
    ...
    doc = load_document("hc_staff", true)
      ...
      assert_equal("#comment", newCommentName, "strong")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_documentcreatecomment"
  end
end
