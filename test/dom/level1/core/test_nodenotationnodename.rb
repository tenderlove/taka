...
##
DOMTestCase('nodenotationnodename') do
  ...
  def test_nodenotationnodename
    ...
    doc = load_document("staff", false)
      ...
      assert_equal("notation1", notationName, "nodeName")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodenotationnodename"
  end
end
