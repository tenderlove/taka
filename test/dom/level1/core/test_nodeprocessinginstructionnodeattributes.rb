...
##
DOMTestCase('nodeprocessinginstructionnodeattributes') do
  ...
  #
  def test_nodeprocessinginstructionnodeattributes
    doc = nil
    testList = nil
    piNode = nil
    attrList = nil
    doc = load_document("staff", false)
      ...
      assert_nil(attrList, "nodeProcessingInstructionNodeAttrAssert1")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/nodeprocessinginstructionnodeattributes"
  end
end
