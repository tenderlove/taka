...
DOMTestCase('hc_nodevalue04') do
  ...
  def test_hc_nodevalue04
    ...
    ((newNode != nil) | ("text/html" == getContentType()))
)
      
      if ((newNode != nil))
        assert_not_nil(newNode, "docTypeNotNull")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_nodevalue04"
  end
end
