...
##
DOMTestCase('elementaddnewattribute') do
  ...
  #
  def test_elementaddnewattribute
    doc = nil
    elementList = nil
    testEmployee = nil
    attrValue = nil
    doc = load_document("staff", true)
      ...
      assert_equal("dallas", attrValue, "elementAddNewAttributeAssert")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/elementaddnewattribute"
  end
end
