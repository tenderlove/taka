...
##
DOMTestCase('hc_nodeattributenodeattribute') do
  ...
  #
  def test_hc_nodeattributenodeattribute
    doc = nil
    elementList = nil
    testAddr = nil
    addrAttr = nil
    ...
    doc = load_document("hc_staff", false)
      ...
      assert_nil(attrList, "nodeAttributeNodeAttributeAssert1")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_nodeattributenodeattribute"
  end
end
