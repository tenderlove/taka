...
##
DOMTestCase('hc_nodedocumentfragmentnodename') do
  ...
  #
  def test_hc_nodedocumentfragmentnodename
    doc = nil
    docFragment = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_nodedocumentfragmentnodename"
  end
end
