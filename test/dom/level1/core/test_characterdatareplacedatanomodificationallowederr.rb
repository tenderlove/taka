...
# see[http://www.w3.org/TR/1998/REC-DOM-Level-1-19981001/level-one-core#ID-E5CBA7FB]
##
DOMTestCase('characterdatareplacedatanomodificationallowederr') do
  ...
  #
  def test_characterdatareplacedatanomodificationallowederr
    doc = nil
    genderList = nil
    genderNode = nil
    entElement = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/characterdatareplacedatanomodificationallowederr"
  end
end
