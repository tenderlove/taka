...
DOMTestCase('initEvent05') do
  ...
  #
  def test_initEvent05
    doc = nil
    event = nil
    expectedEventType = "rotate";
    actualEventType = nil
    expectedCanBubble = false;
    actualCanBubble = nil
    expectedCancelable = true;
    ...
    doc = load_document("hc_staff", true)
      ...
      assert_equal(expectedEventType, actualEventType, "type")
            
      assert_equal(expectedCancelable, actualCancelable, "cancelable")
            
      assert_equal(expectedCanBubble, actualCanBubble, "canBubble")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/initEvent05"
  end
end
