...
##
DOMTestCase('setAttributeNS04') do
...
=end
  ...
  def test_setAttributeNS04
    ...
    doc = load_document("staffNS", true)
      ...
      assert_equal("http://www.nist.gov", resultNamespaceURI, "nsuri")
            
      assert_equal("zone", resultLocalName, "lname")
            
      assert_equal("newprefix", resultPrefix, "prefix")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/setAttributeNS04"
  end
end
