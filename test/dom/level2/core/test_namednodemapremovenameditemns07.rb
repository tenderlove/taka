...
##
DOMTestCase('namednodemapremovenameditemns07') do
...
=end
  ...
  #
  def test_namednodemapremovenameditemns07
    doc = nil
    attributes = nil
    element = nil
    attribute = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/namednodemapremovenameditemns07"
  end
end
