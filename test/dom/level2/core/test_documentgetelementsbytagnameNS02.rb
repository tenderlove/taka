...
##
DOMTestCase('documentgetelementsbytagnameNS02') do
...
=end
  ...
  #
  def test_documentgetelementsbytagnameNS02
    doc = nil
    docElem = nil
    element = nil
    childList = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/documentgetelementsbytagnameNS02"
  end
end
