...
##
DOMTestCase('documentgetelementsbytagnameNS05') do
  ...
  #
  def test_documentgetelementsbytagnameNS05
    doc = nil
    childList = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/documentgetelementsbytagnameNS05"
  end
end
