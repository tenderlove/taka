...
##
DOMTestCase('setAttributeNS10') do
  ...
  #
  def test_setAttributeNS10
    namespaceURI = "http://www.example.gov";
    doc = nil
    elementList = nil
    testAddr = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/setAttributeNS10"
  end
end
