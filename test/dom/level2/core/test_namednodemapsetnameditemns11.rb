...
##
DOMTestCase('namednodemapsetnameditemns11') do
...
=end
  ...
  #
  def test_namednodemapsetnameditemns11
    doc = nil
    docType = nil
    notations = nil
    attributes = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/namednodemapsetnameditemns11"
  end
end
