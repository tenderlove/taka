...
##
DOMTestCase('documentimportnode12') do
...
=end
  ...
  #
  def test_documentimportnode12
    doc = nil
    childList = nil
    imported = nil
    addressElem = nil
    addressElemChildren = nil
    importedChildren = nil
    addressElemLen = nil
    importedLen = nil
    doc = load_document("staffNS", true)
      ...
      assert_equal(importedLen, addressElemLen, "documentimportnode12")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/documentimportnode12"
  end
end
