...
##
DOMTestCase('setAttributeNS05') do
  ...
  def test_setAttributeNS05
    ...
    doc = load_document("staffNS", true)
      ...
      assert_equal("<newValue>", resultAttr, "throw_Equals")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/setAttributeNS05"
  end
end
