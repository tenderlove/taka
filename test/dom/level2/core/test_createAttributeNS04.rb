...
##
DOMTestCase('createAttributeNS04') do
  ...
  #
  def test_createAttributeNS04
    namespaceURI = "http://www.w3.org/XML/1998/namespaces";
    qualifiedName = "xml:attr1";
    doc = nil
    newAttr = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/createAttributeNS04"
  end
end
