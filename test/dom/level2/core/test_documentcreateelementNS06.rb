...
##
DOMTestCase('documentcreateelementNS06') do
  ...
  #
  def test_documentcreateelementNS06
    doc = nil
    newDoc = nil
    docType = nil;
    ...
    begin
      ...
      assert(success, "documentcreateelementNS06")
    end
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/documentcreateelementNS06"
  end
end
