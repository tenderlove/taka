...
##
DOMTestCase('documentcreateelementNS02') do
  ...
  #
  def test_documentcreateelementNS02
    doc = nil
    element = nil
    namespaceURI = nil;
    ...
    begin
      ...
      assert(success, "documentcreateelementNS02")
    end
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/documentcreateelementNS02"
  end
end
