...
##
DOMTestCase('namednodemapremovenameditemns04') do
...
=end
  ...
  #
  def test_namednodemapremovenameditemns04
    doc = nil
    attributes = nil
    element = nil
    attribute = nil
    attributeRemoved = nil
    elementList = nil
    doc = load_document("staffNS", true)
      ...
      assert_nil(attribute, "namednodemapremovenameditemns04_1")
      
      
      assert_nil(attribute, "namednodemapremovenameditemns04_2")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/namednodemapremovenameditemns04"
  end
end
