...
=end
  ...
  #
  def test_localName04
    doc = nil
    elementList = nil
    testEmployee = nil
    employeeLocalName = nil
    doc = load_document("staffNS", false)
      elementList = doc.getElementsByTagName("employee")
      testEmployee = elementList.item(0)
      
      assert_equal("employee", employeeLocalName, "lname")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/localName04"
  end
end
