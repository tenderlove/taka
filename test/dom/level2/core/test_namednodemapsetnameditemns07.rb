...
##
DOMTestCase('namednodemapsetnameditemns07') do
...
=end
  ...
  #
  def test_namednodemapsetnameditemns07
    doc = nil
    attributes = nil
    elementList = nil
    element = nil
    ...
    begin
      ...
      assert(success, "namednodemapsetnameditemns07")
    end
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/namednodemapsetnameditemns07"
  end
end
