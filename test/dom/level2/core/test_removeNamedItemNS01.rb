...
##
DOMTestCase('removeNamedItemNS01') do
...
=end
  ...
  def test_removeNamedItemNS01
    ...
    doc = load_document("staffNS", true)
      ...
      assert_not_nil(removedNode, "retval")
      newAttr = attributes.getNamedItem("dmstc:domestic")
      assert_nil(newAttr, "nodeRemoved")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/removeNamedItemNS01"
  end
end
