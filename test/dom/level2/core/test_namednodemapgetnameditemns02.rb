...
##
DOMTestCase('namednodemapgetnameditemns02') do
...
=end
  ...
  #
  def test_namednodemapgetnameditemns02
    doc = nil
    attributes = nil
    element = nil
    attribute = nil
    ...
    doc = load_document("staffNS", false)
      ...
      assert_equal("emp:domestic", attrName, "namednodemapgetnameditemns02")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/namednodemapgetnameditemns02"
  end
end
