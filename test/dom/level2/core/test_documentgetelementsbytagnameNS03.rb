...
##
DOMTestCase('documentgetelementsbytagnameNS03') do
  ...
  #
  def test_documentgetelementsbytagnameNS03
    doc = nil
    childList = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/documentgetelementsbytagnameNS03"
  end
end
