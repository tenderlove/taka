...
##
DOMTestCase('documentimportnode04') do
...
=end
  ...
  def test_documentimportnode04
    ...
    doc = load_document("staffNS", true)
      ...
      assert_equal("defaultAttr", nodeName, "documentimportnode04_nodeName")
            assert_equal(2, nodeType, "documentimportnode04_nodeType")
            assert_equal("defaultVal", nodeValue, "documentimportnode04_nodeValue")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/documentimportnode04"
  end
end
