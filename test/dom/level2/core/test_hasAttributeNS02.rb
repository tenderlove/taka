...
##
DOMTestCase('hasAttributeNS02') do
  ...
  #
  def test_hasAttributeNS02
    localName = "domestic";
    namespaceURI = "http://www.nomatch.com";
    doc = nil
    elementList = nil
    testNode = nil
    state = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hasAttributeNS02"
  end
end
