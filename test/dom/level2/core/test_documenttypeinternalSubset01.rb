...
##
DOMTestCase('documenttypeinternalSubset01') do
  ...
  #
  def test_documenttypeinternalSubset01
    doc = nil
    docType = nil
    domImpl = nil
    internal = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/documenttypeinternalSubset01"
  end
end
