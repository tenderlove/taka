...
##
DOMTestCase('attrgetownerelement03') do
  ...
  #
  def test_attrgetownerelement03
    doc = nil
    ownerElement = nil
    attr = nil
    doc = load_document("staffNS", false)
      ...
      assert_nil(ownerElement, "attrgetownerelement03")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/attrgetownerelement03"
  end
end
