...
##
DOMTestCase('hc_entitiesremovenameditemns1') do
  ...
  #
  def test_hc_entitiesremovenameditemns1
    doc = nil
    entities = nil
    docType = nil
    retval = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_entitiesremovenameditemns1"
  end
end
