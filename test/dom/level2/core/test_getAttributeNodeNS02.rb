...
##
DOMTestCase('getAttributeNodeNS02') do
...
=end
  ...
  def test_getAttributeNodeNS02
    ...
    doc = load_document("staffNS", false)
      ...
      assert_equal("emp:domestic", attrName, "attrName")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/getAttributeNodeNS02"
  end
end
