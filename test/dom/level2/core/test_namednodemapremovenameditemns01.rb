...
##
DOMTestCase('namednodemapremovenameditemns01') do
...
=end
  ...
  #
  def test_namednodemapremovenameditemns01
    doc = nil
    attributes = nil
    element = nil
    attribute = nil
    ...
    doc = load_document("staffNS", true)
      ...
      assert_nil(attribute, "namednodemapremovenameditemns01")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/namednodemapremovenameditemns01"
  end
end
