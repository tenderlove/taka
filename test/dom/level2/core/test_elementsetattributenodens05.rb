...
##
DOMTestCase('elementsetattributenodens05') do
...
=end
  ...
  #
  def test_elementsetattributenodens05
    doc = nil
    docAlt = nil
    element = nil
    attribute = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/elementsetattributenodens05"
  end
end
