...
##
DOMTestCase('documenttypesystemid01') do
  ...
  #
  def test_documenttypesystemid01
    doc = nil
    docType = nil
    domImpl = nil
    publicId = nil
    ...
    doc = load_document("staffNS", false)
      ...
      assert_equal("PUB", publicId, "documenttypepublicid01")
            assert_equal("SYS", systemId, "documenttypesystemid01")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/documenttypesystemid01"
  end
end
