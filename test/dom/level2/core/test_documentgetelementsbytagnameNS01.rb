...
##
DOMTestCase('documentgetelementsbytagnameNS01') do
  ...
  #
  def test_documentgetelementsbytagnameNS01
    doc = nil
    newDoc = nil
    docType = nil;
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/documentgetelementsbytagnameNS01"
  end
end
