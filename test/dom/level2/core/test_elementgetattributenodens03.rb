...
##
DOMTestCase('elementgetattributenodens03') do
...
=end
  ...
  #
  def test_elementgetattributenodens03
    doc = nil
    element = nil
    attribute = nil
    attrValue = nil
    ...
    doc = load_document("staffNS", false)
      ...
      assert_equal("defaultVal", attrValue, "elementgetattributenodens03")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/elementgetattributenodens03"
  end
end
