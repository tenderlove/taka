...
##
DOMTestCase('namednodemapremovenameditemns06') do
...
=end
  ...
  #
  def test_namednodemapremovenameditemns06
    doc = nil
    attributes = nil
    element = nil
    attribute = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/namednodemapremovenameditemns06"
  end
end
