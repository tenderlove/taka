...
=end
  ...
  def test_namespaceURI02
    ...
    doc = load_document("staffNS", false)
      ...
      assert_not_nil(testAddr, "empAddressNotNull")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/namespaceURI02"
  end
end
