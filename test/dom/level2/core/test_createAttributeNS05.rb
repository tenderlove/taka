...
##
DOMTestCase('createAttributeNS05') do
  ...
  #
  def test_createAttributeNS05
    namespaceURI = "http://www.ecommerce.org/";
    qualifiedName = "econm:local";
    doc = nil
    newAttr = nil
    attrName = nil
    doc = load_document("staffNS", false)
      ...
      assert_equal(qualifiedName, attrName, "throw_Equals")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/createAttributeNS05"
  end
end
