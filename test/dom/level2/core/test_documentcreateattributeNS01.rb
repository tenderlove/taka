...
##
DOMTestCase('documentcreateattributeNS01') do
  ...
  #
  def test_documentcreateattributeNS01
    doc = nil
    attribute = nil
    namespaceURI = nil;
    ...
    doc = load_document("staffNS", false)
      ...
      assert_equal("test", nodeName, "documentcreateattributeNS01")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/documentcreateattributeNS01"
  end
end
