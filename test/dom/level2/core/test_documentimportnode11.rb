...
##
DOMTestCase('documentimportnode11') do
...
=end
  ...
  #
  def test_documentimportnode11
    doc = nil
    docElement = nil
    imported = nil
    success = nil
    nodeNameOrig = nil
    nodeNameImported = nil
...
nodeNameImported = imported.nodeName()
      ...
      assert_equal(nodeNameImported, nodeNameOrig, "documentimportnode11_NodeName")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/documentimportnode11"
  end
end
