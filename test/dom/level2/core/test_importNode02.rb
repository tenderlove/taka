...
value = aNode.nodeValue()
      assert_equal("this is CDATASection data", value, "nodeValue")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/importNode02"
  end
end
