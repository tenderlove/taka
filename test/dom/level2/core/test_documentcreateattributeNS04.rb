...
##
DOMTestCase('documentcreateattributeNS04') do
  ...
  #
  def test_documentcreateattributeNS04
    doc = nil
    attribute = nil
    ...
    doc = load_document("staffNS", false)
      indexid2360959 = 0
    while (indexid2360959 < qualifiedNames.size())
      qualifiedName = qualifiedNames.get(indexid2360959)
    ...
    begin
      ...
      assert(success, "documentcreateattributeNS04")
    end
indexid2360959 += 1
            end
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/documentcreateattributeNS04"
  end
end
