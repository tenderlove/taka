...
##
DOMTestCase('documentimportnode01') do
...
=end
  ...
  def test_documentimportnode01
    ...
    doc = load_document("staffNS", true)
      ...
      assert_equal("street", nodeName, "documentimportnode01_nodeName")
            assert_equal(2, nodeType, "documentimportnode01_nodeType")
            assert_equal("Yes", nodeValue, "documentimportnode01_nodeValue")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/documentimportnode01"
  end
end
