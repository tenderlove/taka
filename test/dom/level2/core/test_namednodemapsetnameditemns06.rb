...
##
DOMTestCase('namednodemapsetnameditemns06') do
...
=end
  ...
  #
  def test_namednodemapsetnameditemns06
    doc = nil
    attributes = nil
    elementList = nil
    element = nil
    ...
    begin
      ...
      assert(success, "namednodemapsetnameditemns06")
    end
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/namednodemapsetnameditemns06"
  end
end
