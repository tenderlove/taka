...
##
DOMTestCase('namednodemapsetnameditemns03') do
...
=end
  ...
  #
  def test_namednodemapsetnameditemns03
    doc = nil
    docAlt = nil
    attributes = nil
    attributesAlt = nil
    ...
    doc = load_document("staffNS", true)
      ...
      docAlt = load_document("staffNS", true)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/namednodemapsetnameditemns03"
  end
end
