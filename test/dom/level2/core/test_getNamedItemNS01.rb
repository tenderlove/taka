...
##
DOMTestCase('getNamedItemNS01') do
...
=end
  ...
  def test_getNamedItemNS01
    ...
    doc = load_document("staffNS", false)
      ...
      assert_equal("dmstc:domestic", attrName, "attrName")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/getNamedItemNS01"
  end
end
