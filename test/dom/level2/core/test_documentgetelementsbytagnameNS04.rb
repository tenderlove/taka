...
##
DOMTestCase('documentgetelementsbytagnameNS04') do
...
=end
  ...
  #
  def test_documentgetelementsbytagnameNS04
    doc = nil
    childList = nil
    nullNS = nil;
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/documentgetelementsbytagnameNS04"
  end
end
