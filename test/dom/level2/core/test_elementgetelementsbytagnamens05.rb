...
##
DOMTestCase('elementgetelementsbytagnamens05') do
...
=end
  ...
  #
  def test_elementgetelementsbytagnamens05
    doc = nil
    element = nil
    elementList = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/elementgetelementsbytagnamens05"
  end
end
