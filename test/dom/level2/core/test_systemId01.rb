...
DOMTestCase('systemId01') do
  ...
  def test_systemId01
    ...
    doc = load_document("staffNS", false)
      ...
      assertURIEquals("systemId", nil, nil, nil, "staffNS.dtd", nil, nil, nil, nil, systemId)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/systemId01"
  end
end
