...
##
DOMTestCase('documentgetelementbyid01') do
  ...
  #
  def test_documentgetelementbyid01
    doc = nil
    element = nil
    elementId = "---";
    doc = load_document("staffNS", false)
      element = doc.getElementById(elementId)
      assert_nil(element, "documentgetelementbyid01")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/documentgetelementbyid01"
  end
end
