...
DOMTestCase('importNode04') do
  ...
  def test_importNode04
    ...
    doc = load_document("staff", true)
      ...
      assert_equal("descendant1", childValue, "descendant1")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/importNode04"
  end
end
