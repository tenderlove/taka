...
##
DOMTestCase('attrgetownerelement04') do
...
=end
  ...
  #
  def test_attrgetownerelement04
    doc = nil
    docImp = nil
    ownerElement = nil
    element = nil
    ...
    doc = load_document("staffNS", false)
      docImp = load_document("staff", false)
      ...
      assert_nil(ownerElement, "attrgetownerelement04")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/attrgetownerelement04"
  end
end
