...
##
DOMTestCase('documentimportnode15') do
...
=end
  ...
  def test_documentimportnode15
    ...
    doc = load_document("staffNS", true)
      ...
      assert_equal("Document.importNode test for a TEXT_NODE", nodeValue, "documentimportnode15")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/documentimportnode15"
  end
end
