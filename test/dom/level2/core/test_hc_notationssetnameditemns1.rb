...
##
DOMTestCase('hc_notationssetnameditemns1') do
  ...
  #
  def test_hc_notationssetnameditemns1
    doc = nil
    notations = nil
    docType = nil
    retval = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/hc_notationssetnameditemns1"
  end
end
