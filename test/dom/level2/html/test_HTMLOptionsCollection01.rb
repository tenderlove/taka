...
##
DOMTestCase('HTMLOptionsCollection01') do
  ...
  #
  def test_HTMLOptionsCollection01
    nodeList = nil
    testNode = nil
    optionsList = nil
    vlength = nil
    ...
    doc = load_document("optionscollection", false)
      ...
      assert_equal(5, vlength, "lengthLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/HTMLOptionsCollection01"
  end
end
