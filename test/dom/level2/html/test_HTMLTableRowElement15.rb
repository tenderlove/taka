...
##
DOMTestCase('HTMLTableRowElement15') do
  ...
  #
  def test_HTMLTableRowElement15
    nodeList = nil
    testNode = nil
    newCell = nil
    doc = nil
    ...
    begin
      ...
      assert(success, "HTMLTableRowElement15")
    end
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/HTMLTableRowElement15"
  end
end
