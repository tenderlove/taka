...
##
DOMTestCase('HTMLImageElement11') do
  ...
  def test_HTMLImageElement11
    ...
    doc = load_document("img", false)
      ...
      assert_equal(10, vvspace, "vspaceLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/HTMLImageElement11"
  end
end
