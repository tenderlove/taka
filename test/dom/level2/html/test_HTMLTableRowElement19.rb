...
##
DOMTestCase('HTMLTableRowElement19') do
  ...
  #
  def test_HTMLTableRowElement19
    nodeList = nil
    testNode = nil
    doc = nil
    ...
    begin
      ...
      assert(success, "HTMLTableRowElement19")
    end
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/HTMLTableRowElement19"
  end
end
