...
##
DOMTestCase('HTMLTableRowElement16') do
  ...
  #
  def test_HTMLTableRowElement16
    nodeList = nil
    testNode = nil
    newCell = nil
    doc = nil
    ...
    begin
      ...
      assert(success, "HTMLTableRowElement16")
    end
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/HTMLTableRowElement16"
  end
end
