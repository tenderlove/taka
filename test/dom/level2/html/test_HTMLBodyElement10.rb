...
##
DOMTestCase('HTMLBodyElement10') do
  ...
  def test_HTMLBodyElement10
    ...
    doc = load_document("document", false)
      ...
      assert_equal(hasXML, state, "isSupportedXHTML")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/HTMLBodyElement10"
  end
end
