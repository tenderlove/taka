...
##
DOMTestCase('HTMLTableElement37') do
  ...
  def test_HTMLTableElement37
    ...
    begin
      ...
      assert(success, "HTMLTableElement37")
    end
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/HTMLTableElement37"
  end
end
