...
##
DOMTestCase('HTMLTableElement36') do
  ...
  def test_HTMLTableElement36
    ...
    begin
      ...
      assert(success, "HTMLTableElement36")
    end
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/HTMLTableElement36"
  end
end
