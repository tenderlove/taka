...
##
DOMTestCase('HTMLTableSectionElement25') do
  ...
  #
  def test_HTMLTableSectionElement25
    nodeList = nil
    testNode = nil
    newRow = nil
    doc = nil
    ...
    begin
      ...
      assert(success, "HTMLTableSectionElement25")
    end
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/HTMLTableSectionElement25"
  end
end
