...
##
DOMTestCase('HTMLTableElement38') do
  ...
  def test_HTMLTableElement38
    ...
    begin
      ...
      assert(success, "HTMLTableElement38")
    end
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/HTMLTableElement38"
  end
end
