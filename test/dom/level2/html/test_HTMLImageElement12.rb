...
##
DOMTestCase('HTMLImageElement12') do
  ...
  def test_HTMLImageElement12
    ...
    doc = load_document("img", false)
      ...
      assert_equal(115, vwidth, "widthLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/HTMLImageElement12"
  end
end
