...
##
DOMTestCase('HTMLBaseFontElement03') do
  ...
  #
  def test_HTMLBaseFontElement03
    nodeList = nil
    testNode = nil
    vsize = nil
    doc = nil
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/HTMLBaseFontElement03"
  end
end
