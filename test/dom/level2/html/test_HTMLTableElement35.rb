...
##
DOMTestCase('HTMLTableElement35') do
  ...
  def test_HTMLTableElement35
    ...
    begin
      ...
      assert(success, "HTMLTableElement35")
    end
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/HTMLTableElement35"
  end
end
