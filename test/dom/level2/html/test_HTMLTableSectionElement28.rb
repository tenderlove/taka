...
##
DOMTestCase('HTMLTableSectionElement28') do
  ...
  #
  def test_HTMLTableSectionElement28
    nodeList = nil
    testNode = nil
    doc = nil
    ...
    begin
      ...
      assert(success, "HTMLTableSectionElement28")
    end
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/HTMLTableSectionElement28"
  end
end
