...
##
DOMTestCase('HTMLImageElement06') do
  ...
  def test_HTMLImageElement06
    ...
    doc = load_document("img", false)
      ...
      assert_equal(4, vhspace, "hspaceLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/HTMLImageElement06"
  end
end
