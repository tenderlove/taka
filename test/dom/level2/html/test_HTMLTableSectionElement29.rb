...
##
DOMTestCase('HTMLTableSectionElement29') do
  ...
  #
  def test_HTMLTableSectionElement29
    nodeList = nil
    testNode = nil
    doc = nil
    ...
    begin
      ...
      assert(success, "HTMLTableSectionElement29")
    end
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/HTMLTableSectionElement29"
  end
end
